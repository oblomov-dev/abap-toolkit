INTERFACE zif_core_types
  ...
  TYPES:
    BEGIN OF ty_s_bind_config,
      ...
      view               TYPE string,
      custom_mapper      TYPE REF TO zif_ajson_mapping,
      custom_mapper_back TYPE REF TO zif_ajson_mapping,
      custom_filter      TYPE REF TO zif_ajson_filter,
      custom_filter_back TYPE REF TO zif_ajson_filter,
  ...
  TYPES:
    BEGIN OF ty_s_attri,
      ...
      view               TYPE string,
      json_bind_local    TYPE REF TO zif_ajson,
      custom_filter      TYPE REF TO zif_ajson_filter,
      custom_filter_back TYPE REF TO zif_ajson_filter,
      custom_mapper      TYPE REF TO zif_ajson_mapping,
      custom_mapper_back TYPE REF TO zif_ajson_mapping,
  ...
  TYPES:
    BEGIN OF ty_s_next,
      o_app_call  TYPE REF TO zif_app,
      o_app_leave TYPE REF TO zif_app,
  ...
  TYPES:
    BEGIN OF ty_s_http_request_post,
      ...
      BEGIN OF s_front,
        ...
        search      TYPE string,
        event       TYPE string,
        o_comp_data TYPE REF TO zif_ajson,
      END OF s_front,
      BEGIN OF s_control,
  ...
  TYPES:
    BEGIN OF ty_s_config,
      ...
      pathname         TYPE string,
      search           TYPE string,
      t_startup_params TYPE zif_types=>ty_t_name_value,
    END OF ty_s_config.
