CLASS zcl_core_attri_srv DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    METHODS attri_search_a_dissolve
      ...
      RETURNING
        VALUE(result) TYPE REF TO zif_core_types=>ty_s_attri.
...
CLASS zcl_core_attri_srv IMPLEMENTATION.
    ...
    LOOP AT mt_attri->* REFERENCE INTO DATA(lr_attri).
      TRY.
          ...
          IF lr_attri->srtti_data IS NOT INITIAL.
            ...
            <val> = zcl_util=>xml_srtti_parse( lr_attri->srtti_data ).
  ...
  METHOD attri_before_save.
    ...
    LOOP AT mt_attri->* REFERENCE INTO DATA(lr_attri).
      ...
      IF lr_attri->bind_type = zif_core_types=>cs_bind_type-one_time.
        DELETE mt_attri->*.
        CONTINUE.
      ENDIF.
      ...
      IF <val_ref> IS NOT INITIAL.
        ...
        lr_attri->srtti_data = zcl_util=>xml_srtti_stringify( <val> ).
        CLEAR <val>.
      ENDIF.
  ...
  METHOD attri_search_a_dissolve.
    ...
    DATA(lo_dissolve) = NEW zcl_core_diss_srv(
       attri = mt_attri
       app   = mo_app ).
