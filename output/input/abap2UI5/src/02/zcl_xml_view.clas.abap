CLASS zcl_xml_view DEFINITION
  PUBLIC FINAL
  CREATE PROTECTED.

  PUBLIC SECTION.
    CLASS-METHODS factory
      IMPORTING t_ns          TYPE zif_types=>ty_t_name_value OPTIONAL
      RETURNING VALUE(result) TYPE REF TO zcl_xml_view.
    ...
    METHODS vbox
      ...
      RETURNING
        VALUE(result)    TYPE REF TO zcl_xml_view.
    ...
    METHODS _generic
      IMPORTING !name         TYPE clike
                !ns           TYPE clike                           OPTIONAL
                t_prop        TYPE zif_types=>ty_t_name_value OPTIONAL
      RETURNING VALUE(result) TYPE REF TO zcl_xml_view.

    METHODS _generic_property
      IMPORTING val           TYPE zif_types=>ty_s_name_value OPTIONAL
      RETURNING VALUE(result) TYPE REF TO zcl_xml_view.
    ...
    METHODS _z2ui5
      RETURNING VALUE(result) TYPE REF TO zcl_xml_view_cc.
  ...
  PROTECTED SECTION.
    ...
    DATA mt_prop     TYPE SORTED TABLE OF zif_types=>ty_s_name_value WITH NON-UNIQUE KEY n.

    DATA mt_ns       TYPE SORTED TABLE OF string WITH UNIQUE KEY table_line.
    DATA mo_root     TYPE REF TO zcl_xml_view.
    DATA mo_previous TYPE REF TO zcl_xml_view.
    DATA mo_parent   TYPE REF TO zcl_xml_view.
    DATA mt_child    TYPE STANDARD TABLE OF REF TO zcl_xml_view WITH EMPTY KEY.
  PRIVATE SECTION.
ENDCLASS.



CLASS zcl_xml_view IMPLEMENTATION.
  ...
  METHOD action_button.
    result = _generic( name   = `ActionButton`
                       ...
                       t_prop = VALUE #( ( n = `id`       v = id )
                                         ...
                                         ( n = `title`    v = title )
                                         ( n = `press`    v = press )
                                         ( n = `enabled`  v = zcl_util=>boolean_abap_2_json( enabled ) ) ) ).
  ENDMETHOD.
  ...
  METHOD action_sheet.
    result = _generic(
                 ...
                 t_prop = VALUE #( ( n = `id`  v = id )
                                   ...
                                   ( n = `visible`           v = zcl_util=>boolean_abap_2_json( visible ) ) ) ).
  ENDMETHOD.
  ...
  METHOD area_micro_chart.
    ...
    _generic( name   = `AreaMicroChart`
              ...
              t_prop = VALUE #( ( n = `colorPalette`  v = colorpalette )
                                ...
                                ( n = `hideOnNoData`    v = zcl_util=>boolean_abap_2_json( hideonnodata ) )
                                ( n = `showLabel`    v = zcl_util=>boolean_abap_2_json( showlabel ) )
                                ( n = `width`  v = width ) ) ).
  ENDMETHOD.
  ...
  METHOD avatar.
    ...
    _generic( name   = `Avatar`
              ...
              t_prop = VALUE #( ( n = `src`         v = src )
                                ...
                                ( n = `showBorder`       v = zcl_util=>boolean_abap_2_json( showborder ) )
                                ( n = `decorative`       v = zcl_util=>boolean_abap_2_json( decorative ) )
                                ( n = `enabled`       v = zcl_util=>boolean_abap_2_json( enabled ) )
  ...
  METHOD base_rectangle.
    ...
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `time`                      v = time )
                          ( n = `endTime`                   v = endtime )
                          ( n = `selectable`                v = zcl_util=>boolean_abap_2_json( selectable ) )
                          ...
                          ( n = `connectable`               v = zcl_util=>boolean_abap_2_json( connectable ) )
                          ( n = `fontFamily`                v = fontfamily )
                          ( n = `filter`                    v = filter )
                          ( n = `transform`                 v = transform )
                          ( n = `countInBirdEye`            v = zcl_util=>boolean_abap_2_json( countinbirdeye ) )
                          ( n = `fontWeight`                v = fontweight )
                          ( n = `showTitle`                 v = zcl_util=>boolean_abap_2_json( showtitle ) )
                          ( n = `selected`                  v = zcl_util=>boolean_abap_2_json( selected ) )
                          ( n = `resizable`                 v = zcl_util=>boolean_abap_2_json( resizable ) )
                          ( n = `horizontalTextAlignment`   v = horizontaltextalignment )
                          ( n = `shapeId`                   v = shapeid )
                          ( n = `highlighted`               v = zcl_util=>boolean_abap_2_json( highlighted ) )
                          ( n = `highlightable`             v = zcl_util=>boolean_abap_2_json( highlightable ) ) ) ).
  ENDMETHOD.
  ...
  METHOD bullet_micro_chart.
    ...
    _generic(
        ...
        t_prop = VALUE #( ( n = `actualValueLabel`  v = actualvaluelabel )
                          ...
                          ( n = `hideOnNoData`    v = zcl_util=>boolean_abap_2_json( hideonnodata ) )
                          ( n = `showActualValue`    v = zcl_util=>boolean_abap_2_json( showactualvalue ) )
                          ( n = `showActualValueInDeltaMode`    v = zcl_util=>boolean_abap_2_json( savidm ) )
                          ( n = `showDeltaValue`    v = zcl_util=>boolean_abap_2_json( showdeltavalue ) )
                          ( n = `showTargetValue`    v = zcl_util=>boolean_abap_2_json( showtargetvalue ) )
                          ( n = `showThresholds`    v = zcl_util=>boolean_abap_2_json( showthresholds ) )
                          ( n = `showValueMarker`    v = zcl_util=>boolean_abap_2_json( showvaluemarker ) )
                          ( n = `smallRangeAllowed`    v = zcl_util=>boolean_abap_2_json( smallrangeallowed ) )
  ...
  METHOD busy_indicator.
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `customIconDensityAware`           v = zcl_util=>boolean_abap_2_json( customicondensityaware ) )
            ( n = `visible`           v = zcl_util=>boolean_abap_2_json( visible ) ) ) ).
  ENDMETHOD.
  ...
  METHOD button.
    ...
    _generic( name   = `Button`
              ...
              t_prop = VALUE #( ( n = `press`   v = press )
                                ...
                                ( n = `enabled` v = zcl_util=>boolean_abap_2_json( enabled ) )
                                ( n = `visible` v = zcl_util=>boolean_abap_2_json( visible ) )
                                ( n = `iconDensityAware` v = zcl_util=>boolean_abap_2_json( icondensityaware ) )
                                ( n = `iconFirst` v = zcl_util=>boolean_abap_2_json( iconfirst ) )
                                ( n = `icon`    v = icon )
                                ( n = `type`    v = type )
                                ( n = `id`      v = id )
                                ( n = `width`   v = width )
  ...
  METHOD calendar_appointment.
    result = _generic( name   = `CalendarAppointment`
                       ...
                       t_prop = VALUE #( ( n = `startDate`                 v = startdate )
                                         ...
                                         ( n = `key`                       v = key )
                                         ( n = `selected`                 v = zcl_util=>boolean_abap_2_json( selected ) )
                                         ( n = `tentative`                 v = zcl_util=>boolean_abap_2_json( tentative ) )
                                       ) ).
  ENDMETHOD.
  ...
  METHOD card_header.
    result = _generic( name   = `Header`
                       ...
                       t_prop = VALUE #( ( n = `id`  v = id )
                                         ...
                                         ( n = `iconVisible`  v = zcl_util=>boolean_abap_2_json( iconvisible ) )
                                         ( n = `visible`    v = zcl_util=>boolean_abap_2_json( visible ) ) ) ).
  ENDMETHOD.
  ...
  METHOD carousel.
    ...
    result = _generic( name   = `Carousel`
                       t_prop = VALUE #( ( n = `loop`  v = zcl_util=>boolean_abap_2_json( loop ) )
                                         ( n = `class`  v = class )
                                         ( n = `height`  v = height )
                                         ( n = `id`  v = id )
  ...
  METHOD checkbox.
    ...
    _generic( name   = `CheckBox`
              t_prop = VALUE #( ( n = `text`     v = text )
                                ...
                                ( n = `width` v = width )
                                ( n = `activeHandling`  v = zcl_util=>boolean_abap_2_json( activehandling ) )
                                ( n = `enabled`  v = zcl_util=>boolean_abap_2_json( enabled ) )
                                ( n = `visible`  v = zcl_util=>boolean_abap_2_json( visible ) )
                                ( n = `displayOnly`  v = zcl_util=>boolean_abap_2_json( displayonly ) )
                                ( n = `editable`  v = zcl_util=>boolean_abap_2_json( editable ) )
                                ( n = `partiallySelected`  v = zcl_util=>boolean_abap_2_json( partiallyselected ) )
                                ( n = `useEntireWidth`  v = zcl_util=>boolean_abap_2_json( useentirewidth ) )
                                ( n = `wrapping`  v = zcl_util=>boolean_abap_2_json( wrapping ) )
                                ( n = `select`   v = select )
                                ( n = `required`   v = zcl_util=>boolean_abap_2_json( required ) ) ) ).
  ENDMETHOD.
  ...
  METHOD column.
    result = _generic(
                 ...
                 t_prop = VALUE #( ( n = `width` v = width )
                                   ...
                                   ( n = `id`         v = id )
                                   ( n = `class`         v = class )
                                   ( n = `mergeDuplicates` v = zcl_util=>boolean_abap_2_json( mergeduplicates ) )
                                   ( n = `visible` v = zcl_util=>boolean_abap_2_json( visible ) )
                                   ( n = `demandPopin` v = zcl_util=>boolean_abap_2_json( demandpopin ) ) ) ).
  ENDMETHOD.
  ...
  METHOD column_list_item.
    result = _generic( name   = `ColumnListItem`
                       t_prop = VALUE #( ( n = `vAlign`   v = valign )
                                         ( n = `id` v = id )
                                         ( n = `selected` v = zcl_util=>boolean_abap_2_json( selected ) )
                                         ( n = `unread` v = zcl_util=>boolean_abap_2_json( unread ) )
                                         ( n = `visible` v = zcl_util=>boolean_abap_2_json( visible ) )
                                         ( n = `type`     v = type )
                                         ( n = `counter`     v = counter )
                                         ...
                                         ( n = `navigated`     v = zcl_util=>boolean_abap_2_json( navigated ) )
                                         ( n = `press`    v = press ) ) ).
  ENDMETHOD.
  ...
  METHOD column_menu_item.
    result = _generic( name   = `Item`
                       ...
                       t_prop = VALUE #(
                           ...
                           ( n = `confirm`    v = confirm )
                           ( n = `reset`    v = reset )
                           ( n = `resetButtonEnabled`  v = zcl_util=>boolean_abap_2_json( resetbuttonenabled ) )
                           ( n = `showCancelButton`  v = zcl_util=>boolean_abap_2_json( showcancelbutton ) )
                           ( n = `showConfirmButton`  v = zcl_util=>boolean_abap_2_json( showconfirmbutton ) )
                           ( n = `showResetButton`  v = zcl_util=>boolean_abap_2_json( showresetbutton ) )
                           ( n = `visible`  v = zcl_util=>boolean_abap_2_json( visible ) ) ) ).
  ENDMETHOD.
  ...
  METHOD column_menu_quick_group_item.
    result = _generic( name   = `QuickGroupItem`
                       ...
                       t_prop = VALUE #( ( n = `id`       v = id )
                                         ...
                                         ( n = `key`    v = key )
                                         ( n = `label`    v = label )
                                         ( n = `grouped`  v = zcl_util=>boolean_abap_2_json( grouped ) )
                                         ( n = `visible`  v = zcl_util=>boolean_abap_2_json( visible ) ) ) ).
  ENDMETHOD.
  ...
  METHOD column_menu_quick_total_item.
    result = _generic( name   = `QuickTotalItem`
                       ...
                       t_prop = VALUE #( ( n = `id`       v = id )
                                         ...
                                         ( n = `key`    v = key )
                                         ( n = `label`    v = label )
                                         ( n = `totaled`  v = zcl_util=>boolean_abap_2_json( totaled ) )
                                         ( n = `visible`  v = zcl_util=>boolean_abap_2_json( visible ) ) ) ).
  ENDMETHOD.
  ...
  METHOD column_micro_chart.
    ...
    _generic(
        ...
        t_prop = VALUE #( ( n = `width`  v = width )
                          ...
                          ( n = `alignContent`      v = aligncontent )
                          ( n = `hideOnNoData`    v = zcl_util=>boolean_abap_2_json( hideonnodata ) )
                          ( n = `allowColumnLabels`    v = zcl_util=>boolean_abap_2_json( allowcolumnlabels ) )
                          ( n = `showBottomLabels`    v = zcl_util=>boolean_abap_2_json( showbottomlabels ) )
                          ( n = `showTopLabels`    v = zcl_util=>boolean_abap_2_json( showtoplabels ) )
                          ( n = `height`  v = height ) ) ).
  ENDMETHOD.
  ...
  METHOD combobox.
    result = _generic(
        name   = `ComboBox`
        t_prop = VALUE #(
            (  n = `showClearIcon` v = zcl_util=>boolean_abap_2_json( showclearicon ) )
            ...
            (  n = `textAlign`         v = textalign )
            (  n = `showSecondaryValues`         v = zcl_util=>boolean_abap_2_json( showsecondaryvalues ) )
            (  n = `visible`         v = zcl_util=>boolean_abap_2_json( visible ) )
            (  n = `showValueStateMessage`         v = zcl_util=>boolean_abap_2_json( showvaluestatemessage ) )
            (  n = `showButton`         v = zcl_util=>boolean_abap_2_json( showbutton ) )
            (  n = `required`         v = zcl_util=>boolean_abap_2_json( required ) )
            (  n = `editable`         v = zcl_util=>boolean_abap_2_json( editable ) )
            (  n = `enabled`         v = zcl_util=>boolean_abap_2_json( enabled ) )
            (  n = `filterSecondaryValues`         v = zcl_util=>boolean_abap_2_json( filtersecondaryvalues ) )
            (  n = `width`         v = width )
  ...
  METHOD comparison_micro_chart.
    ...
    _generic( name   = `ComparisonMicroChart`
              ...
              t_prop = VALUE #( ( n = `colorPalette`  v = colorpalette )
                                ...
                                ( n = `width`      v = width )
                                ( n = `hideOnNoData`    v = zcl_util=>boolean_abap_2_json( hideonnodata ) )
                                ( n = `shrinkable`    v = zcl_util=>boolean_abap_2_json( shrinkable ) )
                                ( n = `view`  v = view ) ) ).
  ENDMETHOD.
  ...
  METHOD container_toolbar.
    ...
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `alignCustomContentToRight` v = zcl_util=>boolean_abap_2_json( aligncustomcontenttoright ) )
            ( n = `findMode`                  v = findmode )
            ( n = `infoOfSelectItems`         v = infoofselectitems )
            ( n = `findbuttonpress`           v = findbuttonpress )
            ( n = `showBirdEyeButton`         v = zcl_util=>boolean_abap_2_json( showbirdeyebutton ) )
            ( n = `showDisplayTypeButton`     v = zcl_util=>boolean_abap_2_json( showdisplaytypebutton ) )
            ( n = `showLegendButton`          v = zcl_util=>boolean_abap_2_json( showlegendbutton ) )
            ( n = `showSettingButton`         v = zcl_util=>boolean_abap_2_json( showsettingbutton ) )
            ( n = `showTimeZoomControl`       v = zcl_util=>boolean_abap_2_json( showtimezoomcontrol ) )
  ...
  METHOD currency.
    result = _generic( name   = `Currency`
                       ...
                       t_prop = VALUE #( ( n = `value`        v = value )
                                         ...
                                         ( n = `useSymbol`    v = zcl_util=>boolean_abap_2_json( usesymbol ) )
  ...
  METHOD date_picker.
    ...
    _generic( name   = `DatePicker`
              t_prop = VALUE #(
                  ...
                  ( n = `visible`               v = zcl_util=>boolean_abap_2_json( visible ) )
                  ( n = `editable`              v = zcl_util=>boolean_abap_2_json( editable ) )
                  ( n = `hideInput`             v = zcl_util=>boolean_abap_2_json( hideinput ) )
                  ( n = `showFooter`            v = zcl_util=>boolean_abap_2_json( showfooter ) )
                  ( n = `showValueStateMessage` v = zcl_util=>boolean_abap_2_json( showvaluestatemessage ) )
                  ( n = `showCurrentDateButton` v = zcl_util=>boolean_abap_2_json( showcurrentdatebutton ) ) ) ).
  ENDMETHOD.
  ...
  METHOD dialog.
    ...
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `title`  v = title )
                          ...
                          ( n = `closeOnNavigation`  v = zcl_util=>boolean_abap_2_json( closeonnavigation ) )
                          ( n = `draggable`  v = zcl_util=>boolean_abap_2_json( draggable ) )
                          ( n = `resizable`  v = zcl_util=>boolean_abap_2_json( resizable ) )
                          ( n = `horizontalScrolling`  v = zcl_util=>boolean_abap_2_json( horizontalscrolling ) )
                          ( n = `verticalScrolling`  v = zcl_util=>boolean_abap_2_json( verticalscrolling ) )
                          ( n = `afterOpen`  v = afteropen )
                          ( n = `beforeClose`  v = beforeclose )
                          ( n = `beforeOpen`  v = beforeopen )
                          ( n = `afterClose` v = afterclose ) ) ).
  ...
  METHOD dynamic_page.
    result = _generic( name   = `DynamicPage`
                       ns     = `f`
                       t_prop = VALUE #(
                           (  n = `headerExpanded`           v = zcl_util=>boolean_abap_2_json( headerexpanded ) )
                           (  n = `headerPinned`           v = zcl_util=>boolean_abap_2_json( headerpinned ) )
                           (  n = `showFooter`           v = zcl_util=>boolean_abap_2_json( showfooter ) )
  ...
  METHOD dynamic_page_header.
    result = _generic(
                 ...
                 ns     = `f`
                 t_prop = VALUE #( (  n = `pinnable`           v = zcl_util=>boolean_abap_2_json( pinnable ) ) ) ).
  ENDMETHOD.
  ...
  METHOD expandable_text.
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ...
                     ( n = `renderWhitespace`             v = zcl_util=>boolean_abap_2_json( renderwhitespace ) )
                     ( n = `text`        v = text )
                     ( n = `textAlign`         v = textalign )
                     ( n = `textDirection`       v = textdirection )
  ...
  METHOD facet_filter.
    result = _generic( name   = `FacetFilter`
                       t_prop = VALUE #(
                           ( n = `id`  v = id )
                           ( n = `class`  v = class )
                           ( n = `liveSearch`  v = zcl_util=>boolean_abap_2_json( livesearch ) )
                           ( n = `showPersonalization` v = zcl_util=>boolean_abap_2_json( showpersonalization ) )
                           ( n = `showPopoverOKButton`  v = zcl_util=>boolean_abap_2_json( showpopoverokbutton ) )
                           ( n = `showReset`             v = zcl_util=>boolean_abap_2_json( showreset ) )
                           ( n = `showSummaryBar`        v = zcl_util=>boolean_abap_2_json( showsummarybar ) )
                           ( n = `type`         v = type )
                           ( n = `confirm`        v = confirm )
                           ( n = `reset` v = reset )
                           ( n = `lists` v = lists )
  ...
  METHOD facet_filter_list.
    result = _generic(
        ...
        t_prop = VALUE #(
            ( n = `id`  v = id )
            ( n = `class`  v = class )
            ( n = `active`  v = zcl_util=>boolean_abap_2_json( active ) )
            ( n = `allCount`  v = allcount )
            ( n = `backgroundDesign`         v = backgrounddesign )
            ( n = `dataType`  v = datatype )
            ( n = `enableBusyIndicator` v = zcl_util=>boolean_abap_2_json( enablebusyindicator ) )
            ( n = `enableCaseInsensitiveSearch` v = zcl_util=>boolean_abap_2_json( enablecaseinsensitivesearch ) )
            ( n = `footerText`         v = footertext )
            ( n = `growing`       v = zcl_util=>boolean_abap_2_json( growing ) )
            ( n = `growingDirection`        v = growingdirection )
            ( n = `growingScrollToLoad` v = zcl_util=>boolean_abap_2_json( growingscrolltoload ) )
            ( n = `growingThreshold` v = growingthreshold )
            ( n = `growingTriggerText` v = growingtriggertext )
            ( n = `headerLevel` v = headerlevel )
            ( n = `includeItemInSelection` v = zcl_util=>boolean_abap_2_json( includeiteminselection ) )
            ( n = `inset` v = zcl_util=>boolean_abap_2_json( inset ) )
            ( n = `key` v = key )
            ( n = `swipedirection` v = swipedirection )
            ( n = `headerText` v = headertext )
            ( n = `keyboardMode` v = keyboardmode )
            ( n = `mode` v = mode )
            ( n = `modeAnimationOn` v = zcl_util=>boolean_abap_2_json( modeanimationon ) )
            ( n = `multiSelectMode` v = multiselectmode )
            ( n = `noDataText` v = nodatatext )
            ( n = `rememberSelections` v = zcl_util=>boolean_abap_2_json( rememberselections ) )
            ( n = `retainListSequence` v = zcl_util=>boolean_abap_2_json( retainlistsequence ) )
            ( n = `sequence` v = sequence )
            ( n = `showNoData` v = zcl_util=>boolean_abap_2_json( shownodata ) )
            ( n = `showRemoveFacetIcon` v = zcl_util=>boolean_abap_2_json( showremovefaceticon ) )
            ( n = `showSeparators` v = showseparators )
            ( n = `showUnread` v = zcl_util=>boolean_abap_2_json( showunread ) )
            ( n = `sticky` v = sticky )
            ( n = `title` v = title )
            ( n = `width` v = width )
            ( n = `wordWrap` v = zcl_util=>boolean_abap_2_json( wordwrap ) )
  ...
  METHOD feed_input.
    result = _generic(
                 ...
                 t_prop = VALUE #( ( n = `buttonTooltip`    v = buttontooltip )
                                   ...
                                   ( n = `placeholder`      v = placeholder )
                                   ( n = `rows`             v = rows )
                                   ( n = `showExceededText` v = zcl_util=>boolean_abap_2_json( showexceededtext ) )
                                   ( n = `showIcon`         v = zcl_util=>boolean_abap_2_json( showicon ) )
                                   ( n = `value`            v = value )
                                   ( n = `class`            v = class )
                                   ( n = `post`             v = post ) ) ).
  ...
  METHOD feed_list_item.
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ...
                     ( n = `iconActive`                  v = zcl_util=>boolean_abap_2_json( iconactive ) )
                     ( n = `icon`                        v = icon )
                     ( n = `iconDensityAware`            v = zcl_util=>boolean_abap_2_json( icondensityaware ) )
                     ( n = `iconDisplayShape`            v = icondisplayshape )
                     ( n = `iconInitials`                v = iconinitials )
                     ...
                     ( n = `sender`                      v = sender )
                     ( n = `senderActive`                v = zcl_util=>boolean_abap_2_json( senderactive ) )
                     ( n = `showIcon`                    v = zcl_util=>boolean_abap_2_json( showicon ) )
                     ( n = `text`                        v = text )
  ...
  METHOD feed_list_item_action.
    result = _generic( name   = `FeedListItemAction`
                       t_prop = VALUE #( ( n = `enabled` v = zcl_util=>boolean_abap_2_json( enabled ) )
                                         ( n = `icon`    v = icon )
                                         ( n = `key`     v = key )
                                         ( n = `text`    v = text )
                                         ( n = `press`   v = press )
  ...
  METHOD filter_bar.
    ...
    result = _generic(
        ...
        ns     = 'fb'
        t_prop = VALUE #(
            ( n = 'useToolbar'     v = zcl_util=>boolean_abap_2_json( usetoolbar ) )
            ( n = 'search'         v = search )
            ( n = 'id'             v = id )
            ...
            ( n = 'header' v = header )
            ( n = 'advancedMode' v = zcl_util=>boolean_abap_2_json( advancedmode ) )
            ( n = 'isRunningInValueHelpDialog' v = zcl_util=>boolean_abap_2_json( isrunninginvaluehelpdialog ) )
            ( n = 'showAllFilters' v = zcl_util=>boolean_abap_2_json( showallfilters ) )
            ( n = 'showClearOnFB' v = zcl_util=>boolean_abap_2_json( showclearonfb ) )
            ( n = 'showFilterConfiguration' v = zcl_util=>boolean_abap_2_json( showfilterconfiguration ) )
            ( n = 'showGoOnFB' v = zcl_util=>boolean_abap_2_json( showgoonfb ) )
            ( n = 'showRestoreButton' v = zcl_util=>boolean_abap_2_json( showrestorebutton ) )
            ( n = 'showRestoreOnFB' v = zcl_util=>boolean_abap_2_json( showrestoreonfb ) )
            ( n = 'useSnapshot' v = zcl_util=>boolean_abap_2_json( usesnapshot ) )
            ( n = 'searchEnabled' v = zcl_util=>boolean_abap_2_json( searchenabled ) )
            ( n = 'considerGroupTitle' v = zcl_util=>boolean_abap_2_json( considergrouptitle ) )
            ( n = 'deltaVariantMode' v = zcl_util=>boolean_abap_2_json( deltavariantmode ) )
            ( n = 'disableSearchMatchesPatternWarning'
              v = zcl_util=>boolean_abap_2_json( disablesearchmatchespatternw ) )
            ( n = 'filterBarExpanded' v = zcl_util=>boolean_abap_2_json( filterbarexpanded ) )
  ...
  METHOD filter_group_item.
    result = _generic( name   = `FilterGroupItem`
                       ...
                       t_prop = VALUE #( ( n = 'name'                v  = name )
                                         ...
                                         ( n = 'change'           v  = change )
                                         ( n = 'visibleInFilterBar'  v  = zcl_util=>boolean_abap_2_json( visibleinfilterbar ) )
                                         ( n = 'mandatory'  v  = zcl_util=>boolean_abap_2_json( mandatory ) )
                                         ( n = 'hiddenFilter'  v  = zcl_util=>boolean_abap_2_json( hiddenfilter ) )
                                         ( n = 'visible'  v  = zcl_util=>boolean_abap_2_json( visible ) )
                                       ) ).
  ...
  METHOD flexible_column_layout.
    ...
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            (  n = `autoFocus` v = zcl_util=>boolean_abap_2_json( autofocus ) )
            (  n = `restoreFocusOnBackNavigation` v = zcl_util=>boolean_abap_2_json( restorefocusonbacknavigation ) ) ) ).
  ...
  METHOD flex_box.
    result = _generic(
                 ...
                 t_prop = VALUE #( ( n = `class`  v = class )
                                   ...
                                   ( n = `fitContainer`  v = zcl_util=>boolean_abap_2_json( fitcontainer ) )
                                   ...
                                   ( n = `alignContent`  v = aligncontent )
                                   ( n = `backgroundDesign`  v = backgrounddesign )
                                   ( n = `displayInline`  v = zcl_util=>boolean_abap_2_json( displayinline ) )
                                   ( n = `visible`        v = zcl_util=>boolean_abap_2_json( visible ) ) ) ).
  ENDMETHOD.
  ...
  METHOD gantt_chart_with_table.
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `isConnectorDetailsVisible` v = zcl_util=>boolean_abap_2_json( isconnectordetailsvisible ) ) ) ).
  ENDMETHOD.
  ...
  METHOD generic_tile.
    ...
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ...
                     ( n = `visible`  v = zcl_util=>boolean_abap_2_json( visible ) )
                     ( n = `renderOnThemeChange`  v = zcl_util=>boolean_abap_2_json( renderonthemechange ) )
                     ( n = `enableNavigationButton`  v = zcl_util=>boolean_abap_2_json( enablenavigationbutton ) )
                     ( n = `pressEnabled`  v = zcl_util=>boolean_abap_2_json( pressenabled ) )
                     ( n = `iconLoaded`  v = zcl_util=>boolean_abap_2_json( iconloaded ) )
  ...
  METHOD grid.
    ...
    result = _generic( name   = `Grid`
                       ...
                       t_prop = VALUE #( ( n = `defaultSpan`    v = default_span )
                                         ( n = `class`          v = class )
                                         ( n = `containerQuery` v = zcl_util=>boolean_abap_2_json( containerquery ) )
  ...
  METHOD grid_data.
    ...
    _generic( name   = `GridData`
              ...
              t_prop = VALUE #( ( n = `span`      v = span )
                                ( n = `linebreak` v = zcl_util=>boolean_abap_2_json( linebreak ) )
                                ( n = `indentL`   v = indentl )
                                ( n = `indentM`   v = indentm ) ) ).
  ENDMETHOD.
  ...
  METHOD group.
    result = _generic( name   = `group`
                       ns     = `networkgraph`
                       t_prop = VALUE #( ( n = `collapsed`  v = zcl_util=>boolean_abap_2_json( collapsed ) )
                                         ( n = `id`       v = id )
                                         ( n = `class`       v = class )
  ...
  METHOD harvey_ball_micro_chart.
    ...
    _generic( name   = `HarveyBallMicroChart`
              ...
              t_prop = VALUE #( ( n = `colorPalette`  v = colorpalette )
                                ...
                                ( n = `alignContent`      v = aligncontent )
                                ( n = `hideOnNoData`    v = zcl_util=>boolean_abap_2_json( hideonnodata ) )
                                ( n = `formattedLabel`    v = zcl_util=>boolean_abap_2_json( formattedlabel ) )
                                ( n = `showFractions`    v = zcl_util=>boolean_abap_2_json( showfractions ) )
                                ( n = `showTotal`    v = zcl_util=>boolean_abap_2_json( showtotal ) )
  ...
  METHOD header_container_control.
    result = _generic(
                 ...
                 t_prop = VALUE #( ( n = `backgroundDesign` v = backgrounddesign )
                                   ( n = `gridLayout` v = zcl_util=>boolean_abap_2_json( gridlayout ) )
                                   ( n = `height` v = height )
                                   ( n = `orientation` v = orientation )
                                   ( n = `scrollStep` v = scrollstep )
                                   ( n = `scrollStepByItem` v = scrollstepbyitem )
                                   ( n = `scrollTime` v = scrolltime )
                                   ( n = `showDividers` v = zcl_util=>boolean_abap_2_json( showdividers ) )
                                   ( n = `showOverflowItem` v = zcl_util=>boolean_abap_2_json( showoverflowitem ) )
                                   ( n = `visible` v = zcl_util=>boolean_abap_2_json( visible ) )
                                   ( n = `snapToRow ` v = zcl_util=>boolean_abap_2_json( snaptorow ) )
                                   ( n = `width` v = width )
                                   ( n = `id` v = id )
                                   ( n = `scroll` v = scroll ) ) ).
  ENDMETHOD.
  ...
  METHOD horizontal_layout.
    result = _generic(
                 ...
                 ns     = `layout`
                 t_prop = VALUE #( ( n = `class`  v = class )
                                   ( n = `allowWrapping`  v = zcl_util=>boolean_abap_2_json( allowwrapping ) )
                                   ( n = `id`  v = id )
                                   ( n = `visible`  v = visible ) ) ).
  ENDMETHOD.
  ...
  METHOD html.
    ...
    result = _generic( name   = `HTML`
                       ...
                       t_prop = VALUE #(
                           ...
                           ( n = 'preferDOM' v = zcl_util=>boolean_abap_2_json( preferdom ) )
                           ( n = 'sanitizeContent' v = zcl_util=>boolean_abap_2_json( sanitizecontent ) )
                           ( n = 'visible' v = zcl_util=>boolean_abap_2_json( visible ) ) ) ).
  ...
  METHOD icon.
    ...
    _generic( name   = `Icon`
              ...
              t_prop = VALUE #( ( n = `size`  v = size )
                                ...
                                ( n = `visible`  v = zcl_util=>boolean_abap_2_json( visible ) )
                                ( n = `decorative`  v = zcl_util=>boolean_abap_2_json( decorative ) )
                                ( n = `noTabStop`  v = zcl_util=>boolean_abap_2_json( notabstop ) )
                                ( n = `useIconTooltip`  v = zcl_util=>boolean_abap_2_json( useicontooltip ) ) ) ).
  ...
  METHOD icon_tab_bar.
    ...
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ...
                     ( n = `select`      v = select )
                     ( n = `expand`      v = expand )
                     ( n = `expandable`  v = zcl_util=>boolean_abap_2_json( expandable ) )
                     ( n = `expanded`    v = zcl_util=>boolean_abap_2_json( expanded ) )
                     ( n = `applyContentPadding`    v = zcl_util=>boolean_abap_2_json( applycontentpadding ) )
                     ( n = `backgroundDesign`    v = backgrounddesign )
                     ( n = `enableTabReordering`    v = zcl_util=>boolean_abap_2_json( enabletabreordering ) )
                     ( n = `headerBackgroundDesign`    v = headerbackgrounddesign )
                     ( n = `stretchContentHeight`    v = zcl_util=>boolean_abap_2_json( stretchcontentheight ) )
                     ...
                     ( n = `id`    v = id )
                     ( n = `content`    v = content )
                     ( n = `upperCase`    v = zcl_util=>boolean_abap_2_json( uppercase ) )
                     ( n = `selectedKey` v = selectedkey ) ) ).
  ENDMETHOD.
  ...
  METHOD icon_tab_filter.
    ...
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `icon`        v = icon )
                          ...
                          ( n = `showAll`     v = zcl_util=>boolean_abap_2_json( showall ) )
                          ( n = `iconDensityAware`     v = zcl_util=>boolean_abap_2_json( icondensityaware ) )
                          ( n = `visible`     v = zcl_util=>boolean_abap_2_json( visible ) )
                          ( n = `count`       v = count )
                          ( n = `text`        v = text )
  ...
  METHOD illustrated_message.
    ...
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `enableFormattedText`             v = zcl_util=>boolean_abap_2_json( enableformattedtext ) )
  ...
  METHOD image.
    ...
    _generic( name   = `Image`
              t_prop = VALUE #( ( n = `id` v = id )
                                ...
                                ( n = `load` v = load )
                                ( n = `decorative` v = zcl_util=>boolean_abap_2_json( decorative ) )
                                ( n = `densityAware` v = zcl_util=>boolean_abap_2_json( densityaware ) )
                                ( n = `lazyLoading` v = zcl_util=>boolean_abap_2_json( lazyloading ) ) ) ).
  ENDMETHOD.
  ...
  METHOD input.
    ...
    _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `enabled`          v = zcl_util=>boolean_abap_2_json( enabled ) )
            ( n = `visible`          v = zcl_util=>boolean_abap_2_json( visible ) )
            ( n = `enableTableAutoPopinMode` v = zcl_util=>boolean_abap_2_json( enabletableautopopinmode ) )
            ( n = `enableSuggestionsHighlighting`  v = zcl_util=>boolean_abap_2_json( enablesuggestionshighlighting ) )
            ( n = `showTableSuggestionValueHelp`   v = zcl_util=>boolean_abap_2_json( showtablesuggestionvaluehelp ) )
            ( n = `valueState`       v = valuestate )
            ( n = `valueStateText`   v = valuestatetext )
            ( n = `value`            v = value )
            ( n = `required`          v = zcl_util=>boolean_abap_2_json( required ) )
            ...
            ( n = `showSuggestion`   v = zcl_util=>boolean_abap_2_json( showsuggestion ) )
            ( n = `valueHelpRequest` v = valuehelprequest )
            ( n = `autocomplete`     v = zcl_util=>boolean_abap_2_json( autocomplete ) )
            ( n = `valueLiveUpdate`  v = zcl_util=>boolean_abap_2_json( valueliveupdate ) )
            ( n = `submit`           v = zcl_util=>boolean_abap_2_json( submit ) )
            ( n = `showValueHelp`    v = zcl_util=>boolean_abap_2_json( showvaluehelp ) )
            ( n = `valueHelpOnly`    v = zcl_util=>boolean_abap_2_json( valuehelponly ) )
            ( n = `class`            v = class )
            ( n = `change`            v = change )
  ...
  METHOD interact_bar_chart.
    result = _generic( name   = `InteractiveBarChart`
                       ...
                       t_prop = VALUE #( ( n = `selectionChanged`  v = selectionchanged )
                                         ( n = `selectionEnabled`  v = zcl_util=>boolean_abap_2_json( selectionenabled ) )
                                         ( n = `showError`         v = zcl_util=>boolean_abap_2_json( showerror ) )
                                         ( n = `press`             v = press )
  ...
  METHOD label.
    ...
    _generic( name   = `Label`
              t_prop = VALUE #( ( n = `text`     v = text )
                                ( n = `displayOnly`   v = zcl_util=>boolean_abap_2_json( displayonly ) )
                                ( n = `required`   v = zcl_util=>boolean_abap_2_json( required ) )
                                ( n = `showColon`   v = zcl_util=>boolean_abap_2_json( showcolon ) )
                                ( n = `textAlign`   v = textalign )
                                ( n = `textDirection`   v = textdirection )
                                ( n = `vAlign`   v = valign )
                                ( n = `width`   v = width )
  ...
  METHOD layered_layout.
    result = _generic( name   = `LayeredLayout`
                       ...
                       t_prop = VALUE #( ( n = `id`  v = id )
                                         ...
                                         ( n = `mergeEdges`  v = zcl_util=>boolean_abap_2_json( mergeedges ) ) ) ).
  ENDMETHOD.
  ...
  METHOD library_shape.
    result = _generic( name   = `LibraryShape`
                       ...
                       t_prop = VALUE #( ( n = `id`       v = id )
                                         ( n = `class`    v = class )
                                         ( n = `animationOnChange`     v = zcl_util=>boolean_abap_2_json( animationonchange ) )
  ...
  METHOD line.
    ...
    result = _generic( name   = `Line`
                       ...
                       t_prop = VALUE #(
                           ...
                           ( n = `hover`        v = hover )
                           ( n = `press`        v = press )
                           ( n = `stretchToCenter`           v = zcl_util=>boolean_abap_2_json( stretchtocenter ) )
                           ( n = `selected`           v = zcl_util=>boolean_abap_2_json( selected ) )
                           ( n = `visible`           v = zcl_util=>boolean_abap_2_json( visible ) ) ) ).
  ...
  METHOD line_micro_chart.
    ...
    _generic(
        ...
        t_prop = VALUE #( ( n = `color`  v = color )
                          ...
                          ( n = `hideOnNoData`    v = zcl_util=>boolean_abap_2_json( hideonnodata ) )
                          ( n = `showBottomLabels`    v = zcl_util=>boolean_abap_2_json( showbottomlabels ) )
                          ( n = `showPoints`    v = zcl_util=>boolean_abap_2_json( showpoints ) )
                          ( n = `showThresholdLine`    v = zcl_util=>boolean_abap_2_json( showthresholdline ) )
                          ( n = `showThresholdValue`    v = zcl_util=>boolean_abap_2_json( showthresholdvalue ) )
                          ( n = `showTopLabels`    v = zcl_util=>boolean_abap_2_json( showtoplabels ) )
                          ( n = `maxYValue`  v = maxyvalue ) ) ).
  ENDMETHOD.
  ...
  METHOD line_micro_chart_empszd_point.
    result = _generic( name   = `LineMicroChartEmphasizedPoint`
                       ...
                       t_prop = VALUE #(
                                        ...
                                        ( n = `y`       v = y )
                                        ( n = `color`       v = color )
                                        ( n = `show`       v = zcl_util=>boolean_abap_2_json( show ) )
                                       ) ).
  ENDMETHOD.
  ...
  METHOD link.
    ...
    _generic( name   = `Link`
              ...
              t_prop = VALUE #( ( n = `text`    v = text )
                                ...
                                ( n = `emptyIndicatorMode`      v = emptyindicatormode )
                                ( n = `rel`      v = rel )
                                ( n = `subtle`      v = zcl_util=>boolean_abap_2_json( subtle ) )
                                ( n = `textAlign`      v = textalign )
                                ( n = `textDirection`      v = textdirection )
                                ( n = `validateUrl`      v = zcl_util=>boolean_abap_2_json( validateurl ) )
                                ( n = `width`      v = width )
                                ( n = `wrapping`      v = zcl_util=>boolean_abap_2_json( wrapping ) )
                                ( n = `emphasized`      v = zcl_util=>boolean_abap_2_json( emphasized ) )
                                ( n = `enabled` v = zcl_util=>boolean_abap_2_json( enabled ) ) ) ).
  ENDMETHOD.
  ...
  METHOD map_container.
    ...
    result = _generic( name   = `MapContainer`
                       ...
                       t_prop = VALUE #(
                           ( n = `id`  v = id )
                           ( n = `autoAdjustHeight`  v = zcl_util=>boolean_abap_2_json( autoadjustheight ) ) ) ).
  ...
  METHOD message_item.
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `type`                v = type )
                          ...
                          ( n = `textDirection`       v = textdirection )
                          ( n = `groupName`           v = groupname )
                          ( n = `activeTitle`         v = zcl_util=>boolean_abap_2_json( activetitle ) )
                          ( n = `counter`             v = counter )
                          ( n = `markupDescription`   v = zcl_util=>boolean_abap_2_json( markupdescription ) ) ) ).
  ENDMETHOD.
  ...
  METHOD message_page.
    result = _generic(
                 name   = `MessagePage`
                 t_prop = VALUE #(
                     ( n = `showHeader`          v = zcl_util=>boolean_abap_2_json( show_header ) )
                     ( n = `description`         v = description )
                     ( n = `icon`                v = icon )
                     ( n = `text`                v = text )
                     ( n = `enableFormattedText` v = zcl_util=>boolean_abap_2_json( enableformattedtext ) ) ) ).
  ...
  METHOD message_popover.
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `items`             v = items )
                          ...
                          ( n = `afterClose`        v = afterclose )
                          ( n = `beforeClose`       v = beforeclose )
                          ( n = `initiallyExpanded` v = zcl_util=>boolean_abap_2_json( initiallyexpanded ) )
                          ( n = `groupItems`        v = zcl_util=>boolean_abap_2_json( groupitems ) ) ) ).
  ENDMETHOD.
  ...
  METHOD message_strip.
    ...
    _generic( name   = `MessageStrip`
              t_prop = VALUE #( ( n = `text`     v = text )
                                ...
                                ( n = `customIcon`       v = customicon )
                                ( n = `visible`  v = zcl_util=>boolean_abap_2_json( visible ) )
                                ( n = `showCloseButton`  v = zcl_util=>boolean_abap_2_json( showclosebutton ) )
                                ( n = `class`    v = class ) ) ).
  ENDMETHOD.
  ...
  METHOD micro_process_flow_item.
    result = _generic( name   = `MicroProcessFlowItem`
                       ...
                       t_prop = VALUE #( ( n = `id`       v = id )
                                         ...
                                         ( n = `key`    v = key )
                                         ( n = `icon`    v = icon )
                                         ( n = `showSeparator`    v = zcl_util=>boolean_abap_2_json( showseparator ) )
                                         ( n = `showIntermediary`    v = zcl_util=>boolean_abap_2_json( showintermediary ) )
                                      ) ).
  ENDMETHOD.
  ...
  METHOD network_graph.
    result = _generic( name   = `Graph`
                       ...
                       t_prop = VALUE #(
                           ...
                           ( n = `enableWheelZoom`           v = zcl_util=>boolean_abap_2_json( enablewheelzoom ) )
                           ( n = `enableZoom`           v = zcl_util=>boolean_abap_2_json( enablezoom ) )
                           ( n = `noData`           v = zcl_util=>boolean_abap_2_json( nodata ) )
                           ( n = `visible`           v = zcl_util=>boolean_abap_2_json( visible ) ) ) ).
  ...
  METHOD node.
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `hover` v = hover )
            ( n = `press` v = press )
            ( n = `collapsed`           v = zcl_util=>boolean_abap_2_json( collapsed ) )
            ( n = `selected`           v = zcl_util=>boolean_abap_2_json( selected ) )
            ( n = `showActionLinksButton`           v = zcl_util=>boolean_abap_2_json( showactionlinksbutton ) )
            ( n = `showDetailButton`           v = zcl_util=>boolean_abap_2_json( showdetailbutton ) )
            ( n = `showExpandButton`           v = zcl_util=>boolean_abap_2_json( showexpandbutton ) )
            ( n = `visible`           v = zcl_util=>boolean_abap_2_json( visible ) ) ) ).
  ...
  METHOD notification_list_group.
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ...
                     ( n = `visible`           v = zcl_util=>boolean_abap_2_json( visible ) )
                     ( n = `autoPriority`           v = zcl_util=>boolean_abap_2_json( autopriority ) )
                     ( n = `collapsed`           v = zcl_util=>boolean_abap_2_json( collapsed ) )
                     ( n = `enableCollapseButtonWhenEmpty`
                       v = zcl_util=>boolean_abap_2_json( enablecollapsebuttonwhenempty ) )
                     ( n = `navigated`           v = zcl_util=>boolean_abap_2_json( navigated ) )
                     ( n = `selected`           v = zcl_util=>boolean_abap_2_json( selected ) )
                     ( n = `showButtons`           v = zcl_util=>boolean_abap_2_json( showbuttons ) )
                     ( n = `showCloseButton`           v = zcl_util=>boolean_abap_2_json( showclosebutton ) )
                     ( n = `showEmptyGroup`           v = zcl_util=>boolean_abap_2_json( showemptygroup ) )
                     ( n = `showItemsCounter`           v = zcl_util=>boolean_abap_2_json( showitemscounter ) )
                     ( n = `unread`           v = zcl_util=>boolean_abap_2_json( unread ) ) ) ).
  ENDMETHOD.
  ...
  METHOD notification_list_item.
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ...
                     ( n = `press`  v = press )
                     ( n = `visible`           v = zcl_util=>boolean_abap_2_json( visible ) )
                     ( n = `hideShowMoreButton`           v = zcl_util=>boolean_abap_2_json( hideshowmorebutton ) )
                     ( n = `truncate`           v = zcl_util=>boolean_abap_2_json( truncate ) )
                     ( n = `highlight`           v = zcl_util=>boolean_abap_2_json( highlight ) )
                     ( n = `navigated`           v = zcl_util=>boolean_abap_2_json( navigated ) )
                     ( n = `selected`           v = zcl_util=>boolean_abap_2_json( selected ) )
                     ( n = `showButtons`           v = zcl_util=>boolean_abap_2_json( showbuttons ) )
                     ( n = `showCloseButton`           v = zcl_util=>boolean_abap_2_json( showclosebutton ) )
  ...
  METHOD numeric_content.
    ...
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `value`      v = value )
                          ...
                          ( n = `visible` v = zcl_util=>boolean_abap_2_json( visible ) )
                          ( n = `nullifyValue` v = zcl_util=>boolean_abap_2_json( nullifyvalue ) )
                          ( n = `formatterValue` v = zcl_util=>boolean_abap_2_json( formattervalue ) )
                          ( n = `animateTextChange` v = zcl_util=>boolean_abap_2_json( animatetextchange ) )
                          ( n = `adaptiveFontSize` v = zcl_util=>boolean_abap_2_json( adaptivefontsize ) )
                          ( n = `withMargin` v = zcl_util=>boolean_abap_2_json( withmargin ) )
                          ( n = `class`      v = class )
                          ( n = `press`      v = press ) ) ).
  ...
  METHOD numeric_header.
    ...
    result = _generic( name   = `NumericHeader`
                       ...
                       t_prop = VALUE #(
                           ...
                           ( n = `statusVisible`           v = zcl_util=>boolean_abap_2_json( statusvisible ) )
                           ( n = `numberVisible`           v = zcl_util=>boolean_abap_2_json( numbervisible ) )
                           ( n = `iconVisible`           v = zcl_util=>boolean_abap_2_json( iconvisible ) )
                           ( n = `visible`           v = zcl_util=>boolean_abap_2_json( visible ) ) ) ).
  ENDMETHOD.
  ...
  METHOD object_header.
    ...
    result = _generic(
        name   = `ObjectHeader`
        t_prop = VALUE #( ( n = `backgrounddesign`     v = backgrounddesign )
                          ( n = `condensed`            v = zcl_util=>boolean_abap_2_json( condensed ) )
                          ( n = `fullscreenoptimized`  v = zcl_util=>boolean_abap_2_json( fullscreenoptimized ) )
                          ( n = `icon`                 v = icon )
                          ( n = `iconactive`           v = zcl_util=>boolean_abap_2_json( iconactive ) )
                          ( n = `iconalt`              v = iconalt )
                          ( n = `icondensityaware`     v = zcl_util=>boolean_abap_2_json( icondensityaware ) )
                          ...
                          ( n = `intro`                v = intro )
                          ( n = `introactive`          v = zcl_util=>boolean_abap_2_json( introactive ) )
                          ...
                          ( n = `responsive`           v = zcl_util=>boolean_abap_2_json( responsive ) )
                          ( n = `showtitleselector`    v = zcl_util=>boolean_abap_2_json( showtitleselector ) )
                          ( n = `title`                v = title )
                          ( n = `titleactive`          v = zcl_util=>boolean_abap_2_json( titleactive ) )
  ...
  METHOD object_number.
    ...
    _generic( name   = `ObjectNumber`
              t_prop = VALUE #( ( n = `emphasized`         v = zcl_util=>boolean_abap_2_json( emphasized ) )
                                ( n = `number`             v = number )
                                ( n = `state`              v = state )
                                ( n = `id`          v = id )
                                ( n = `class`          v = class )
                                ...
                                ( n = `numberunit`         v = numberunit )
                                ( n = `active`             v = zcl_util=>boolean_abap_2_json( active ) )
                                ( n = `inverted`           v = zcl_util=>boolean_abap_2_json( inverted ) )
                                ( n = `visible`            v = zcl_util=>boolean_abap_2_json( visible ) )
                                ( n = `unit`               v = unit ) ) ).
  ENDMETHOD.
  ...
  METHOD object_page_header.
    ...
    _generic(
        ...
        ns     = `uxap`
        t_prop = VALUE #(
            ( n = `isActionAreaAlwaysVisible`  v = zcl_util=>boolean_abap_2_json( isactionareaalwaysvisible ) )
            ( n = `isObjectIconAlwaysVisible`       v = zcl_util=>boolean_abap_2_json( isobjecticonalwaysvisible ) )
            ( n = `isObjectSubtitleAlwaysVisible`
              v = zcl_util=>boolean_abap_2_json( isobjectsubtitlealwaysvisible ) )
            ( n = `isObjectTitleAlwaysVisible`       v = zcl_util=>boolean_abap_2_json( isobjecttitlealwaysvisible ) )
            ( n = `markChanges`       v = zcl_util=>boolean_abap_2_json( markchanges ) )
            ( n = `markFavorite`       v = zcl_util=>boolean_abap_2_json( markfavorite ) )
            ( n = `markFlagged`       v = zcl_util=>boolean_abap_2_json( markflagged ) )
            ( n = `markLocked`       v = zcl_util=>boolean_abap_2_json( marklocked ) )
            ( n = `objectImageDensityAware`       v = zcl_util=>boolean_abap_2_json( objectimagedensityaware ) )
            ( n = `showMarkers`       v = zcl_util=>boolean_abap_2_json( showmarkers ) )
            ( n = `showPlaceholder`       v = zcl_util=>boolean_abap_2_json( showplaceholder ) )
            ( n = `showTitleSelector`       v = zcl_util=>boolean_abap_2_json( showtitleselector ) )
            ( n = `visible`       v = zcl_util=>boolean_abap_2_json( visible ) )
  ...
  METHOD object_page_header_action_btn.
    ...
    _generic( name   = `ObjectPageHeaderActionButton`
              ...
              t_prop = VALUE #( ( n = `activeIcon`  v = activeicon )
                                ...
                                ( n = `width`      v = width )
                                ( n = `enabled`    v = zcl_util=>boolean_abap_2_json( enabled ) )
                                ( n = `hideIcon`    v = zcl_util=>boolean_abap_2_json( hideicon ) )
                                ( n = `hideText`    v = zcl_util=>boolean_abap_2_json( hidetext ) )
                                ( n = `iconDensityAware`    v = zcl_util=>boolean_abap_2_json( icondensityaware ) )
                                ( n = `iconFirst`    v = zcl_util=>boolean_abap_2_json( iconfirst ) )
                                ( n = `visible`    v = zcl_util=>boolean_abap_2_json( visible ) )
                                ( n = `press`  v = press ) ) ).
  ...
  METHOD object_page_layout.
    result = _generic(
        ...
        ns     = `uxap`
        t_prop = VALUE #(
            ( n = `showTitleInHeaderContent` v = zcl_util=>boolean_abap_2_json( showtitleinheadercontent ) )
            ( n = `showEditHeaderButton`     v = zcl_util=>boolean_abap_2_json( showeditheaderbutton ) )
            ( n = `alwaysShowContentHeader`     v = zcl_util=>boolean_abap_2_json( alwaysshowcontentheader ) )
            ( n = `enableLazyLoading`     v = zcl_util=>boolean_abap_2_json( enablelazyloading ) )
            ( n = `flexEnabled`     v = zcl_util=>boolean_abap_2_json( flexenabled ) )
            ( n = `headerContentPinnable`     v = zcl_util=>boolean_abap_2_json( headercontentpinnable ) )
            ( n = `headerContentPinned`     v = zcl_util=>boolean_abap_2_json( headercontentpinned ) )
            ( n = `isChildPage`     v = zcl_util=>boolean_abap_2_json( ischildpage ) )
            ( n = `preserveHeaderStateOnScroll`     v = zcl_util=>boolean_abap_2_json( preserveheaderstateonscroll ) )
            ( n = `showAnchorBar`     v = zcl_util=>boolean_abap_2_json( showanchorbar ) )
            ( n = `showAnchorBarPopover`     v = zcl_util=>boolean_abap_2_json( showanchorbarpopover ) )
            ( n = `showHeaderContent`     v = zcl_util=>boolean_abap_2_json( showheadercontent ) )
            ( n = `showOnlyHighImportance`     v = zcl_util=>boolean_abap_2_json( showonlyhighimportance ) )
            ( n = `subSectionLayout`     v = subsectionlayout )
            ( n = `toggleHeaderOnTitleClick`     v = zcl_util=>boolean_abap_2_json( toggleheaderontitleclick ) )
            ( n = `useIconTabBar`     v = zcl_util=>boolean_abap_2_json( useicontabbar ) )
            ( n = `useTwoColumnsForLargeScreen`     v = zcl_util=>boolean_abap_2_json( usetwocolumnsforlargescreen ) )
            ( n = `visible`     v = zcl_util=>boolean_abap_2_json( visible ) )
            ...
            ( n = `upperCaseAnchorBar`       v = zcl_util=>boolean_abap_2_json( uppercaseanchorbar ) )
  ...
  METHOD object_page_section.
    result = _generic(
                 ...
                 ns     = `uxap`
                 t_prop = VALUE #( ( n = `titleUppercase`  v = zcl_util=>boolean_abap_2_json( titleuppercase ) )
                                   ( n = `title`           v = title )
                                   ( n = `id`              v = id )
                                   ( n = `anchorBarButtonColor`              v = anchorbarbuttoncolor )
                                   ( n = `titleLevel`      v = titlelevel )
                                   ( n = `titleVisible`       v = zcl_util=>boolean_abap_2_json( titlevisible ) )
                                   ( n = `showTitle`       v = zcl_util=>boolean_abap_2_json( showtitle ) )
                                   ( n = `visible`       v = zcl_util=>boolean_abap_2_json( visible ) )
                                   ( n = `wrapTitle`       v = zcl_util=>boolean_abap_2_json( wraptitle ) )
                                   ( n = `importance`      v = importance ) ) ).
  ENDMETHOD.
  ...
  METHOD object_page_sub_section.
    result = _generic(
                 ...
                 t_prop = VALUE #( ( n = `id`    v = id )
                                   ...
                                   ( n = `titleVisible`    v = zcl_util=>boolean_abap_2_json( titlevisible ) )
                                   ( n = `showTitle`    v = zcl_util=>boolean_abap_2_json( showtitle ) )
                                   ( n = `titleUppercase`    v = zcl_util=>boolean_abap_2_json( titleuppercase ) )
                                   ( n = `visible`    v = zcl_util=>boolean_abap_2_json( visible ) )
                                   ( n = `title` v = title ) ) ).
  ENDMETHOD.
  ...
  METHOD object_status.
    result = _generic(
        name   = `ObjectStatus`
        t_prop = VALUE #( ( n = `active`                v = zcl_util=>boolean_abap_2_json( active ) )
                          ( n = `emptyIndicatorMode`    v = emptyindicatormode )
                          ( n = `icon`                  v = icon )
                          ( n = `iconDensityAware`      v = zcl_util=>boolean_abap_2_json( icondensityaware ) )
                          ( n = `inverted`              v = zcl_util=>boolean_abap_2_json( inverted ) )
  ...
  METHOD overflow_toolbar.
    result = _generic( name   = `OverflowToolbar`
                       t_prop = VALUE #( ( n = `press`   v = press )
                                         ...
                                         ( n = `active` v = zcl_util=>boolean_abap_2_json( active ) )
                                         ( n = `visible` v = zcl_util=>boolean_abap_2_json( visible ) )
                                         ( n = `asyncMode` v = zcl_util=>boolean_abap_2_json( asyncmode ) )
                                         ( n = `enabled` v = zcl_util=>boolean_abap_2_json( enabled ) )
                                         ( n = `design`    v = design )
                                         ( n = `type`    v = type )
                                         ( n = `style`    v = style )
  ...
  METHOD page.
    result = _generic(
                 ...
                 ns     = ns
                 t_prop = VALUE #( ( n = `title` v = title )
                                   ( n = `showNavButton`  v = zcl_util=>boolean_abap_2_json( shownavbutton ) )
                                   ( n = `navButtonPress` v = navbuttonpress )
                                   ( n = `showHeader` v = zcl_util=>boolean_abap_2_json( showheader ) )
                                   ( n = `class` v = class )
                                   ( n = `backgroundDesign` v = backgrounddesign )
                                   ( n = `navButtonTooltip` v = navbuttontooltip )
                                   ( n = `titleAlignment` v = titlealignment )
                                   ( n = `titleLevel` v = titlelevel )
                                   ( n = `contentOnlyBusy` v = zcl_util=>boolean_abap_2_json( contentonlybusy ) )
                                   ( n = `enableScrolling` v = zcl_util=>boolean_abap_2_json( enablescrolling ) )
                                   ( n = `floatingFooter` v = zcl_util=>boolean_abap_2_json( floatingfooter ) )
                                   ( n = `showFooter` v = zcl_util=>boolean_abap_2_json( showfooter ) )
                                   ( n = `showSubHeader` v = zcl_util=>boolean_abap_2_json( showsubheader ) )
                                   ( n = `id` v = id ) ) ).
  ENDMETHOD.
  ...
  METHOD panel.
    ...
    result = _generic(
                 name   = `Panel`
                 t_prop = VALUE #( ( n = `expandable` v = zcl_util=>boolean_abap_2_json( expandable ) )
                                   ( n = `expanded`   v = zcl_util=>boolean_abap_2_json( expanded ) )
                                   ( n = `stickyHeader`   v = zcl_util=>boolean_abap_2_json( stickyheader ) )
                                   ( n = `expandAnimation`   v = zcl_util=>boolean_abap_2_json( expandanimation ) )
                                   ( n = `visible`   v = zcl_util=>boolean_abap_2_json( visible ) )
                                   ( n = `height`   v = height )
                                   ( n = `backgroundDesign`   v = backgrounddesign )
                                   ( n = `width`   v = width )
  ...
  METHOD planning_calendar.
    result = _generic( name   = `PlanningCalendar`
                       t_prop = VALUE #( ( n = `rows`                      v = rows )
                                         ...
                                         ( n = `viewKey`         v = viewkey )
                                         ( n = `width`         v = width )
                                         ( n = `singleSelection`  v = zcl_util=>boolean_abap_2_json( singleselection ) )
                                         ( n = `showRowHeaders`  v = zcl_util=>boolean_abap_2_json( showrowheaders ) )
                                         ( n = `multipleAppointmentsSelection`  v = zcl_util=>boolean_abap_2_json( multipleappointmentsselection ) )
                                         ( n = `showIntervalHeaders`  v = zcl_util=>boolean_abap_2_json( showintervalheaders ) )
                                         ( n = `showEmptyIntervalHeaders`  v = zcl_util=>boolean_abap_2_json( showemptyintervalheaders ) )
                                         ( n = `showWeekNumbers`           v = zcl_util=>boolean_abap_2_json( showweeknumbers ) )
                                         ( n = `legend`                    v = legend )
                                         ( n = `showDayNamesLine`          v = zcl_util=>boolean_abap_2_json( showdaynamesline ) ) ) ).
  ENDMETHOD.
  ...
  METHOD planning_calendar_row.
    result = _generic( name   = `PlanningCalendarRow`
                       t_prop = VALUE #( ( n = `appointments`                    v = appointments )
                                         ...
                                         ( n = `enableAppointmentsCreate`        v = zcl_util=>boolean_abap_2_json( enableappointmentscreate ) )
                                         ...
                                         ( n = `selected`                        v = zcl_util=>boolean_abap_2_json( selected ) )
                                         ( n = `nonWorkingDays`                  v = nonworkingdays )
                                         ( n = `enableAppointmentsResize`        v = zcl_util=>boolean_abap_2_json( enableappointmentsresize ) )
                                         ( n = `enableAppointmentsDragAndDrop`   v = zcl_util=>boolean_abap_2_json( enableappointmentsdraganddrop ) )
                                         ( n = `text`                            v = text )
                                       ) ).
  ...
  METHOD planning_calendar_view.
    result = _generic( name   = `PlanningCalendarView`
                       t_prop = VALUE #( ( n = `appointmentHeight`                      v = appointmentheight )
                                         ...
                                         ( n = `key`  v = key )
                                         ( n = `relative`  v = zcl_util=>boolean_abap_2_json( relative ) )
                                         ( n = `showSubIntervals`  v = zcl_util=>boolean_abap_2_json( showsubintervals ) )
                                       ) ).
  ENDMETHOD.
  ...
  METHOD popover.
    result = _generic( name   = `Popover`
                       t_prop = VALUE #( ( n = `title`         v = title )
                                         ...
                                         ( n = `contentHeight` v = contentheight )
                                         ( n = `showHeader`    v = zcl_util=>boolean_abap_2_json( showheader ) )
                                         ( n = `showArrow`    v = zcl_util=>boolean_abap_2_json( showarrow ) )
                                         ( n = `resizable`    v = zcl_util=>boolean_abap_2_json( resizable ) )
                                         ( n = `modal`    v = zcl_util=>boolean_abap_2_json( modal ) )
                                         ( n = `horizontalScrolling`    v = zcl_util=>boolean_abap_2_json( horizontalscrolling ) )
                                         ( n = `verticalScrolling`    v = zcl_util=>boolean_abap_2_json( verticalscrolling ) )
                                         ( n = `visible`    v = zcl_util=>boolean_abap_2_json( visible ) )
                                         ( n = `offsetX`    v = offsetx )
  ...
  METHOD process_flow.
    result = _generic(
                 ...
                 ns     = 'commons'
                 t_prop = VALUE #( ( n = `id`               v = id )
                                   ( n = `foldedCorners`    v = zcl_util=>boolean_abap_2_json( foldedcorners ) )
                                   ( n = `scrollable`       v = zcl_util=>boolean_abap_2_json( scrollable ) )
                                   ( n = `showLabels`       v = zcl_util=>boolean_abap_2_json( showlabels ) )
                                   ( n = `visible`          v = zcl_util=>boolean_abap_2_json( visible ) )
                                   ( n = `wheelZoomable`    v = zcl_util=>boolean_abap_2_json( wheelzoomable ) )
  ...
  METHOD process_flow_node.
    result = _generic(
                 ...
                 t_prop = VALUE #( ( n = `laneId`               v = laneid )
                                   ...
                                   ( n = `texts`                v = texts )
                                   ( n = `highlighted`          v = zcl_util=>boolean_abap_2_json( highlighted ) )
                                   ( n = `focused`              v = zcl_util=>boolean_abap_2_json( focused ) )
                                   ( n = `selected`             v = zcl_util=>boolean_abap_2_json( selected ) )
                                   ( n = `tag`                  v = tag )
                                   ( n = `texts`                v = texts )
                                   ( n = `type`                 v = type ) ) ).
  ...
  METHOD progress_indicator.
    ...
    _generic( name   = `ProgressIndicator`
              t_prop = VALUE #( ( n = `class`        v = class )
                                ...
                                ( n = `displayValue` v = displayvalue )
                                ( n = `showValue`    v = zcl_util=>boolean_abap_2_json( showvalue ) )
                                ( n = `visible`      v = zcl_util=>boolean_abap_2_json( visible ) )
                                ( n = `state`        v = state ) ) ).
  ENDMETHOD.
...
*              ns     = `webc`
              t_prop = VALUE #( ( n = `class`           v = class )
                                ...
                                ( n = `max`   v = max )
                                ( n = `min`   v = min )
                                ( n = `showTickmarks`   v = zcl_util=>boolean_abap_2_json( showtickmarks ) )
  ...
  METHOD rich_text_editor.
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `buttonGroups`        v = buttongroups )
                          ( n = `customToolbar`       v = zcl_util=>boolean_abap_2_json( customtoolbar ) )
                          ( n = `editable`            v = zcl_util=>boolean_abap_2_json( editable ) )
                          ( n = `height`              v = height )
                          ...
                          ( n = `required`            v = zcl_util=>boolean_abap_2_json( required ) )
                          ( n = `sanitizeValue`       v = zcl_util=>boolean_abap_2_json( sanitizevalue ) )
                          ( n = `showGroupClipboard`  v = zcl_util=>boolean_abap_2_json( showgroupclipboard ) )
                          ( n = `showGroupFont`       v = zcl_util=>boolean_abap_2_json( showgroupfont ) )
                          ( n = `showGroupFontStyle`  v = zcl_util=>boolean_abap_2_json( showgroupfontstyle ) )
                          ( n = `showGroupInsert`     v = zcl_util=>boolean_abap_2_json( showgroupinsert ) )
                          ( n = `showGroupLink`       v = zcl_util=>boolean_abap_2_json( showgrouplink ) )
                          ( n = `showGroupStructure`  v = zcl_util=>boolean_abap_2_json( showgroupstructure ) )
                          ( n = `showGroupTextAlign`  v = zcl_util=>boolean_abap_2_json( showgrouptextalign ) )
                          ( n = `showGroupUndo`       v = zcl_util=>boolean_abap_2_json( showgroupundo ) )
                          ( n = `useLegacyTheme`      v = zcl_util=>boolean_abap_2_json( uselegacytheme ) )
                          ( n = `wrapping`            v = zcl_util=>boolean_abap_2_json( wrapping ) )
                          ( n = `width`               v = width ) ) ).
  ...
  METHOD scroll_container.
    result = _generic( name   = `ScrollContainer`
                       t_prop = VALUE #( ( n = `height`      v = height )
                                         ...
                                         ( n = `id`          v = id )
                                         ( n = `visible`     v = zcl_util=>boolean_abap_2_json( visible ) )
                                         ( n = `vertical`    v = zcl_util=>boolean_abap_2_json( vertical ) )
                                         ( n = `horizontal`  v = zcl_util=>boolean_abap_2_json( horizontal ) )
                                         ( n = `focusable`   v = zcl_util=>boolean_abap_2_json( focusable ) ) ) ).
  ENDMETHOD.
  ...
  METHOD search_field.
    ...
    _generic( name   = `SearchField`
              t_prop = VALUE #( ( n = `width`  v = width )
                                ...
                                ( n = `placeholder` v = placeholder )
                                ( n = `suggest` v = suggest )
                                ( n = `enableSuggestions` v = zcl_util=>boolean_abap_2_json( enablesuggestions ) )
                                ( n = `showRefreshButton` v = zcl_util=>boolean_abap_2_json( showrefreshbutton ) )
                                ( n = `showSearchButton` v = zcl_util=>boolean_abap_2_json( showsearchbutton ) )
                                ( n = `visible` v = zcl_util=>boolean_abap_2_json( visible ) )
                                ( n = `enabled` v = zcl_util=>boolean_abap_2_json( enabled ) )
                                ( n = `liveChange` v = livechange ) ) ).
  ENDMETHOD.
  ...
  METHOD select.
    result = _generic( name   = `Select`
                       t_prop = VALUE #(
                           ( n = `id`                  v = id )
                           ( n = `class`                  v = class )
                           ( n = `autoAdjustWidth`     v = zcl_util=>boolean_abap_2_json( autoadjustwidth ) )
                           ( n = `columnRatio`         v = columnratio )
                           ( n = `editable`            v = zcl_util=>boolean_abap_2_json( editable ) )
                           ( n = `enabled`             v = zcl_util=>boolean_abap_2_json( enabled ) )
                           ( n = `forceSelection`      v = zcl_util=>boolean_abap_2_json( forceselection ) )
                           ( n = `icon`                v = icon )
                           ( n = `maxWidth`            v = maxwidth )
                           ( n = `name`                v = name )
                           ( n = `required`            v = zcl_util=>boolean_abap_2_json( required ) )
                           ( n = `resetOnMissingKey`   v = zcl_util=>boolean_abap_2_json( resetonmissingkey ) )
                           ( n = `selectedItemId`      v = selecteditemid )
                           ( n = `selectedKey`         v = selectedkey )
                           ( n = `showSecondaryValues` v = zcl_util=>boolean_abap_2_json( showsecondaryvalues ) )
                           ( n = `textAlign`           v = textalign )
                           ...
                           ( n = `valueStateText`      v = valuestatetext )
                           ( n = `width`               v = width )
                           ( n = `wrapItemsText`       v = zcl_util=>boolean_abap_2_json( wrapitemstext ) )
                           ( n = `items`               v = items )
                           ( n = `selectedItem`        v = selecteditem )
                           ( n = `change`              v = change )
                           ( n = `liveChange`          v = livechange )
  ...
  METHOD shell.
    result = _generic(
        name   = `Shell`
        ns     = ns
        t_prop = VALUE #( ( n = `appWidthLimited`  v = zcl_util=>boolean_abap_2_json( appwidthlimited ) ) ) ).
  ENDMETHOD.
  ...
  METHOD shell_bar.
    result = _generic( name   = `ShellBar`
                       ...
                       t_prop = VALUE #(
                           ...
                           ( n = `showCopilot`  v = zcl_util=>boolean_abap_2_json( showcopilot ) )
                           ( n = `showMenuButton`  v = zcl_util=>boolean_abap_2_json( showmenubutton ) )
                           ( n = `showNavButton`  v = zcl_util=>boolean_abap_2_json( shownavbutton ) )
                           ( n = `showNotifications`  v = zcl_util=>boolean_abap_2_json( shownotifications ) )
                           ( n = `showProductSwitcher`  v = zcl_util=>boolean_abap_2_json( showproductswitcher ) )
                           ( n = `showSearch`  v = zcl_util=>boolean_abap_2_json( showsearch ) )
  ...
  METHOD side_panel.
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `sidePanelWidth`  v = sidepanelwidth )
                          ...
                          ( n = `sidePanelResizable`    v = zcl_util=>boolean_abap_2_json( sidepanelresizable ) )
                          ( n = `actionBarExpanded`    v = zcl_util=>boolean_abap_2_json( actionbarexpanded ) )
                          ( n = `toggle`    v = toggle )
                          ( n = `ariaLabel`  v = arialabel ) ) ).
  ENDMETHOD.
  ...
  METHOD simple_form.
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `minWidth`   v = minwidth )
            ( n = `singleContainerFullSize`   v = zcl_util=>boolean_abap_2_json( singlecontainerfullsize ) )
            ( n = `visible`   v = zcl_util=>boolean_abap_2_json( visible ) )
            ( n = `width`       v = width )
            ( n = `id`       v = id )
...
*              ns     = `webc`
              t_prop = VALUE #( ( n = `class`           v = class )
                                ...
                                ( n = `max`   v = max )
                                ( n = `min`   v = min )
                                ( n = `enableTickmarks`   v = zcl_util=>boolean_abap_2_json( enabletickmarks ) )
                                ( n = `enabled`   v = zcl_util=>boolean_abap_2_json( enabled ) )
                                ( n = `value`   v = value )
                                ( n = `step`   v = step )
                                ( n = `change`   v = change )
  ...
  METHOD smart_variant_management.
    result = _generic(
        ...
        t_prop = VALUE #(
            ( n = `id`      v = id )
            ( n = `showExecuteOnSelection`  v = zcl_util=>boolean_abap_2_json( showexecuteonselection ) ) ) ).
  ENDMETHOD.
  ...
  METHOD stacked_bar_micro_chart.
    ...
    _generic( name   = `StackedBarMicroChart`
              ...
              t_prop = VALUE #( ( n = `height`  v = height )
                                ...
                                ( n = `size`      v = size )
                                ( n = `hideOnNoData`    v = zcl_util=>boolean_abap_2_json( hideonnodata ) )
                                ( n = `displayZeroValue`    v = zcl_util=>boolean_abap_2_json( displayzerovalue ) )
                                ( n = `showLabels`    v = zcl_util=>boolean_abap_2_json( showlabels ) )
                                ( n = `width`  v = width ) ) ).
  ENDMETHOD.
  ...
  METHOD standard_list_item.
    ...
    _generic(
        ...
        t_prop = VALUE #( ( n = `title`       v = title )
                          ...
                          ( n = `counter`     v = counter )
                          ( n = `activeIcon`     v = activeicon )
                          ( n = `adaptTitleSize`     v = zcl_util=>boolean_abap_2_json( adapttitlesize ) )
                          ( n = `unread`     v = zcl_util=>boolean_abap_2_json( unread ) )
                          ( n = `iconInset`     v = zcl_util=>boolean_abap_2_json( iconinset ) )
                          ( n = `infoStateInverted`     v = zcl_util=>boolean_abap_2_json( infostateinverted ) )
                          ( n = `wrapping`     v = zcl_util=>boolean_abap_2_json( wrapping ) )
    ...
    result = _generic( name   = `Status`
                       ...
                       t_prop = VALUE #(
                           ...
                           ( n = `useFocusColorAsContentColor`
                             v = zcl_util=>boolean_abap_2_json( usefocuscolorascontentcolor ) )
                           ( n = `visible`           v = zcl_util=>boolean_abap_2_json( visible ) ) ) ).
  ...
  METHOD table.
    result = _generic( name   = `Table`
                       t_prop = VALUE #(
                           ...
                           ( n = `backgroundDesign`  v = backgrounddesign )
                           ( n = `visible`  v = zcl_util=>boolean_abap_2_json( visible ) )
                           ( n = `alternateRowColors`  v = zcl_util=>boolean_abap_2_json( alternaterowcolors ) )
                           ( n = `fixedLayout`  v = zcl_util=>boolean_abap_2_json( fixedlayout ) )
                           ( n = `showOverlay`  v = zcl_util=>boolean_abap_2_json( showoverlay ) )
                           ( n = `autoPopinMode`  v = zcl_util=>boolean_abap_2_json( autopopinmode ) ) ) ).
  ENDMETHOD.
  ...
  METHOD table_select_dialog.
    ...
    result = _generic( name   = `TableSelectDialog`
                       t_prop = VALUE #(
                           ...
                           ( n = `growing`              v = zcl_util=>boolean_abap_2_json( growing ) )
                           ( n = `growingThreshold`     v = growingthreshold )
                           ( n = `multiSelect`          v = zcl_util=>boolean_abap_2_json( multiselect ) )
                           ( n = `noDataText`           v = nodatatext )
                           ( n = `rememberSelections`   v = zcl_util=>boolean_abap_2_json( rememberselections ) )
                           ( n = `resizable`            v = zcl_util=>boolean_abap_2_json( resizable ) )
                           ( n = `searchPlaceholder`    v = searchplaceholder )
                           ( n = `showClearButton`      v = zcl_util=>boolean_abap_2_json( showclearbutton ) )
                           ( n = `title`                v = title )
                           ( n = `titleAlignment`       v = titlealignment )
                           ( n = `items`                v = items )
                           ( n = `search`               v = search )
  ...
  METHOD tile_content.
    ...
    result = _generic( name   = `TileContent`
                       ...
                       t_prop = VALUE #( ( n = `unit`   v = unit )
                                         ...
                                         ( n = `blocked`   v = zcl_util=>boolean_abap_2_json( blocked ) )
                                         ( n = `frameType`   v = frametype )
                                         ( n = `priority`   v = priority )
                                         ( n = `priorityText`   v = prioritytext )
                                         ( n = `state`   v = state )
                                         ( n = `disabled`   v = zcl_util=>boolean_abap_2_json( disabled ) )
                                         ( n = `visible`   v = zcl_util=>boolean_abap_2_json( visible ) )
                                         ( n = `footer` v = footer )
                                         ( n = `class` v = class ) ) ).
  ...
  METHOD timeline.
    ...
    result = _generic(
        ...
        ns     = 'commons'
        t_prop = VALUE #( ( n = 'id'                 v = id )
                          ( n = 'enableDoubleSided'  v = zcl_util=>boolean_abap_2_json( enabledoublesided ) )
                          ( n = 'groupBy'            v = groupby )
                          ( n = 'growingThreshold'   v = growingthreshold )
                          ( n = 'filterTitle'        v = filtertitle )
                          ( n = 'sortOldestFirst'    v = zcl_util=>boolean_abap_2_json( sortoldestfirst ) )
                          ( n = 'enableModelFilter'  v = zcl_util=>boolean_abap_2_json( enablemodelfilter ) )
                          ( n = 'enableScroll'       v = zcl_util=>boolean_abap_2_json( enablescroll ) )
                          ( n = 'forceGrowing'       v = zcl_util=>boolean_abap_2_json( forcegrowing ) )
                          ( n = 'group'              v = zcl_util=>boolean_abap_2_json( group ) )
                          ( n = 'lazyLoading'        v = zcl_util=>boolean_abap_2_json( lazyloading ) )
                          ( n = 'showHeaderBar'      v = zcl_util=>boolean_abap_2_json( showheaderbar ) )
                          ( n = 'showIcons'          v = zcl_util=>boolean_abap_2_json( showicons ) )
                          ( n = 'showItemFilter'     v = zcl_util=>boolean_abap_2_json( showitemfilter ) )
                          ( n = 'showSearch'         v = zcl_util=>boolean_abap_2_json( showsearch ) )
                          ( n = 'showSort'           v = zcl_util=>boolean_abap_2_json( showsort ) )
                          ( n = 'showTimeFilter'     v = zcl_util=>boolean_abap_2_json( showtimefilter ) )
                          ( n = 'sort'               v = zcl_util=>boolean_abap_2_json( sort ) )
  ...
  METHOD timeline_item.
    ...
    result = _generic(
        ...
        t_prop = VALUE #( ( n = 'id'                     v = id )
                          ( n = 'dateTime'               v = datetime )
                          ( n = 'title'                  v = title )
                          ( n = 'userNameClickable'      v = zcl_util=>boolean_abap_2_json( usernameclickable ) )
                          ( n = 'useIconTooltip'         v = zcl_util=>boolean_abap_2_json( useicontooltip ) )
  ...
  METHOD time_picker.
    ...
    _generic( name   = `TimePicker`
              t_prop = VALUE #(
                  ...
                  ( n = `textDirection`  v = textdirection )
                  ( n = `title`  v = title )
                  ( n = `showCurrentTimeButton` v = zcl_util=>boolean_abap_2_json( showcurrenttimebutton ) )
                  ( n = `showValueStateMessage` v = zcl_util=>boolean_abap_2_json( showvaluestatemessage ) )
                  ( n = `support2400` v = zcl_util=>boolean_abap_2_json( support2400 ) )
                  ( n = `initialFocusedDateValue` v = zcl_util=>boolean_abap_2_json( initialfocuseddatevalue ) )
                  ( n = `hideInput` v = zcl_util=>boolean_abap_2_json( hideinput ) )
                  ( n = `editable` v = zcl_util=>boolean_abap_2_json( editable ) )
                  ( n = `enabled` v = zcl_util=>boolean_abap_2_json( enabled ) )
                  ( n = `required` v = zcl_util=>boolean_abap_2_json( required ) )
  ...
  METHOD toggle_button.
    ...
    _generic( name   = `ToggleButton`
              t_prop = VALUE #( ( n = `press`   v = press )
                                ...
                                ( n = `type`    v = type )
                                ( n = `class`   v = class )
                                ( n = `pressed` v = zcl_util=>boolean_abap_2_json( pressed ) ) ) ).
  ENDMETHOD.
  ...
  METHOD tree_table.
    ...
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ...
                     ( n = `enableColumnReordering`  v = zcl_util=>boolean_abap_2_json( enablecolumnreordering ) )
                     ( n = `expandFirstLevel`        v = zcl_util=>boolean_abap_2_json( expandfirstlevel ) )
                     ( n = `columnSelect`            v = columnselect )
                     ( n = `rowSelectionChange`      v = rowselectionchange )
                     ( n = `selectionBehavior`       v = selectionbehavior )
                     ( n = `id`                      v = id )
                     ( n = `alternateRowColors`      v = zcl_util=>boolean_abap_2_json( alternaterowcolors ) )
                     ( n = `columnHeaderVisible`      v = zcl_util=>boolean_abap_2_json( columnheadervisible ) )
                     ( n = `enableCellFilter`      v = zcl_util=>boolean_abap_2_json( enablecellfilter ) )
                     ( n = `enableColumnFreeze`      v = zcl_util=>boolean_abap_2_json( enablecolumnfreeze ) )
                     ( n = `enableCustomFilter`      v = zcl_util=>boolean_abap_2_json( enablecustomfilter ) )
                     ( n = `enableSelectAll`      v = zcl_util=>boolean_abap_2_json( enableselectall ) )
                     ( n = `showNoData`      v = zcl_util=>boolean_abap_2_json( shownodata ) )
                     ( n = `showOverlay`      v = zcl_util=>boolean_abap_2_json( showoverlay ) )
                     ( n = `visible`      v = zcl_util=>boolean_abap_2_json( visible ) )
                     ...
                     ( n = `threshold`           v = threshold )
                     ( n = `width`           v = width )
                     ( n = `useGroupMode`           v = zcl_util=>boolean_abap_2_json( usegroupmode ) )
  ...
  METHOD ui_column.
    result = _generic( name   = `Column`
                       ...
                       t_prop = VALUE #(
                           ...
                           ( n = `autoresizable`  v = zcl_util=>boolean_abap_2_json( autoresizable ) )
  ...
  METHOD ui_table.
    ...
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `class`                     v = class )
            ( n = `enableCellFilter`          v = zcl_util=>boolean_abap_2_json( enablecellfilter ) )
            ( n = `enableGrouping`            v = zcl_util=>boolean_abap_2_json( enablegrouping ) )
            ( n = `enableSelectAll`           v = zcl_util=>boolean_abap_2_json( enableselectall ) )
            ( n = `firstVisibleRow`           v = firstvisiblerow )
            ( n = `fixedBottomRowCount`       v = fixedbottomrowcount )
            ( n = `fixedColumnCount`          v = fixedcolumncount )
            ...
            ( n = `selectionMode`             v = selectionmode )
            ( n = `selectionBehavior`         v = selectionbehavior )
            ( n = `showColumnVisibilityMenu`  v = zcl_util=>boolean_abap_2_json( showcolumnvisibilitymenu ) )
            ( n = `showNoData`                v = zcl_util=>boolean_abap_2_json( shownodata ) )
            ( n = `threshold`                 v = threshold )
            ( n = `visibleRowCount`           v = visiblerowcount )
            ( n = `visibleRowCountMode`       v = visiblerowcountmode )
  ...
  METHOD upload_set.
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ( n = `id`                       v = id )
                     ( n = `instantUpload`            v = zcl_util=>boolean_abap_2_json( instantupload ) )
                     ( n = `showIcons`                v = zcl_util=>boolean_abap_2_json( showicons ) )
                     ( n = `uploadEnabled`            v = zcl_util=>boolean_abap_2_json( uploadenabled ) )
                     ( n = `terminationEnabled`       v = zcl_util=>boolean_abap_2_json( terminationenabled ) )
                     ( n = `uploadButtonInvisible`    v = zcl_util=>boolean_abap_2_json( uploadbuttoninvisible ) )
                     ...
                     ( n = `directory`                v = zcl_util=>boolean_abap_2_json( directory ) )
                     ( n = `multiple`                 v = zcl_util=>boolean_abap_2_json( multiple ) )
                     ...
                     ( n = `sameFilenameAllowed`      v = zcl_util=>boolean_abap_2_json( samefilenameallowed ) )
  ...
  METHOD upload_set_item.
    result = _generic( name   = `UploadSetItem`
                       ...
                       t_prop = VALUE #( ( n = `fileName`      v = filename )
                                         ...
                                         ( n = `markers`       v = markers )
                                         ( n = `enabledEdit`   v = zcl_util=>boolean_abap_2_json( enablededit ) )
                                         ( n = `enabledRemove` v = zcl_util=>boolean_abap_2_json( enabledremove ) )
                                         ( n = `selected`      v = zcl_util=>boolean_abap_2_json( selected ) )
                                         ( n = `visibleEdit`   v = zcl_util=>boolean_abap_2_json( visibleedit ) )
                                         ( n = `visibleRemove` v = zcl_util=>boolean_abap_2_json( visibleremove ) )
  ...
  METHOD variant_item.
    ...
    result = _generic(
                 ...
                 ns     = `vm`
                 t_prop = VALUE #(
                     ( n = `executeOnSelection`      v = zcl_util=>boolean_abap_2_json( executeonselection ) )
                     ( n = `global`                  v = zcl_util=>boolean_abap_2_json( global ) )
                     ( n = `labelReadOnly`           v = zcl_util=>boolean_abap_2_json( labelreadonly ) )
                     ...
                     ( n = `executeOnSelect`         v = zcl_util=>boolean_abap_2_json( executeonselect ) )
                     ( n = `author`                  v = author )
                     ( n = `changeable`              v = zcl_util=>boolean_abap_2_json( changeable ) )
                     ( n = `enabled`                 v = zcl_util=>boolean_abap_2_json( enabled ) )
                     ( n = `favorite`                v = zcl_util=>boolean_abap_2_json( favorite ) )
                     ( n = `key`                     v = key )
                     ( n = `text`                    v = text )
                     ( n = `title`                   v = title )
                     ( n = `textDirection`           v = textdirection )
                     ( n = `originalTitle`           v = originaltitle )
                     ( n = `originalExecuteOnSelect` v = zcl_util=>boolean_abap_2_json( originalexecuteonselect ) )
                     ( n = `remove`                  v = zcl_util=>boolean_abap_2_json( remove ) )
                     ( n = `rename`                  v = zcl_util=>boolean_abap_2_json( rename ) )
                     ( n = `originalFavorite`        v = zcl_util=>boolean_abap_2_json( originalfavorite ) )
                     ( n = `sharing`                 v = zcl_util=>boolean_abap_2_json( sharing ) )
                     ( n = `change`                  v = change ) ) ).
  ...
  METHOD variant_management.
    ...
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ...
                     ( n = `enabled`                v = zcl_util=>boolean_abap_2_json( enabled ) )
                     ( n = `inErrorState`           v = zcl_util=>boolean_abap_2_json( inerrorstate ) )
                     ( n = `initialSelectionKey`    v = initialselectionkey )
                     ( n = `lifecycleSupport`       v = zcl_util=>boolean_abap_2_json( lifecyclesupport ) )
                     ( n = `selectionKey`           v = selectionkey )
                     ( n = `showCreateTile`         v = zcl_util=>boolean_abap_2_json( showcreatetile ) )
                     ( n = `showExecuteOnSelection` v = zcl_util=>boolean_abap_2_json( showexecuteonselection ) )
                     ( n = `showSetAsDefault`       v = zcl_util=>boolean_abap_2_json( showsetasdefault ) )
                     ( n = `showShare`              v = zcl_util=>boolean_abap_2_json( showshare ) )
                     ( n = `standardItemAuthor`     v = standarditemauthor )
                     ( n = `standardItemText`       v = standarditemtext )
                     ( n = `useFavorites`           v = zcl_util=>boolean_abap_2_json( usefavorites ) )
    ...
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ...
                     ( n = `executeOnSelectionForStandardDefault`
                       v = zcl_util=>boolean_abap_2_json( executeonselectionforstandflt ) )
                     ( n = `headerLevel`      v = headerlevel )
                     ( n = `inErrorState`      v = zcl_util=>boolean_abap_2_json( inerrorstate ) )
                     ( n = `maxWidth`      v = maxwidth )
                     ( n = `modelName`      v = modelname )
                     ( n = `resetOnContextChange`      v = zcl_util=>boolean_abap_2_json( resetoncontextchange ) )
                     ( n = `showSetAsDefault`      v = zcl_util=>boolean_abap_2_json( showsetasdefault ) )
                     ( n = `titleStyle`      v = titlestyle )
                     ( n = `updateVariantInURL`    v = zcl_util=>boolean_abap_2_json( updatevariantinurl ) )
                     ( n = `cancel`    v = cancel )
                     ( n = `initialized`    v = initialized )
                     ( n = `manage`    v = manage )
                     ( n = `save`    v = save )
  ...
  METHOD variant_management_sapm.
    result = _generic( name   = `VariantManagement`
                       t_prop = VALUE #( ( n = `id`       v = id )
                                         ...
                                         ( n = `select`    v = select )
                                         ( n = `items`    v = items )
                                         ( n = `creationAllowed`     v = zcl_util=>boolean_abap_2_json( creationallowed ) )
                                         ( n = `inErrorState`     v = zcl_util=>boolean_abap_2_json( inerrorstate ) )
                                         ( n = `modified`     v = zcl_util=>boolean_abap_2_json( modified ) )
                                         ( n = `showFooter`     v = zcl_util=>boolean_abap_2_json( showfooter ) )
                                         ( n = `showSaveAs`     v = zcl_util=>boolean_abap_2_json( showsaveas ) )
                                         ( n = `supportApplyAutomatically`     v = zcl_util=>boolean_abap_2_json( supportapplyautomatically ) )
                                         ( n = `supportContexts`     v = zcl_util=>boolean_abap_2_json( supportcontexts ) )
                                         ( n = `supportDefault`     v = zcl_util=>boolean_abap_2_json( supportdefault ) )
                                         ( n = `supportFavorites`     v = zcl_util=>boolean_abap_2_json( supportfavorites ) )
                                         ( n = `supportPublic`     v = zcl_util=>boolean_abap_2_json( supportpublic ) )
                                         ( n = `visible`     v = zcl_util=>boolean_abap_2_json( visible ) )
                                       ) ).
  ...
  METHOD view_settings_dialog.
    ...
    result = _generic( name   = `ViewSettingsDialog`
                       t_prop = VALUE #(
                           ...
                           ( n = `groupDescending`          v = zcl_util=>boolean_abap_2_json( groupdescending ) )
                           ( n = `sortDescending`           v = zcl_util=>boolean_abap_2_json( sortdescending ) )
                           ( n = `title`                    v = title )
  ...
  METHOD wizard.
    result = _generic( name   = `Wizard`
                       t_prop = VALUE #(
                           ...
                           ( n = `class`                v = class )
                           ( n = `backgroundDesign`     v = backgrounddesign )
                           ( n = `busy`                 v = zcl_util=>boolean_abap_2_json( busy ) )
                           ( n = `busyIndicatorDelay`   v = busyindicatordelay )
                           ( n = `busyIndicatorSize`    v = busyindicatorsize )
                           ( n = `enableBranching`      v = zcl_util=>boolean_abap_2_json( enablebranching ) )
                           ( n = `fieldGroupIds`        v = fieldgroupids )
                           ( n = `finishButtonText`     v = finishbuttontext )
                           ( n = `height`               v = height )
                           ( n = `renderMode`           v = rendermode )
                           ( n = `showNextButton`       v = zcl_util=>boolean_abap_2_json( shownextbutton ) )
  ...
  METHOD wizard_step.
    ...
    result = _generic( name   = `WizardStep`
                       t_prop = VALUE #(
                           ...
                           (  n = `fieldGroupIds`        v = fieldgroupids )
                           (  n = `icon`                 v = icon )
                           (  n = `optional`             v = zcl_util=>boolean_abap_2_json( optional ) )
                           (  n = `title`                v = title )
                           (  n = `validated`            v = zcl_util=>boolean_abap_2_json( validated ) )
                           (  n = `visible`              v = zcl_util=>boolean_abap_2_json( visible ) )
  ...
  METHOD xml_get.
    DATA lt_prop TYPE zif_types=>ty_t_name_value.
...
*                       ( n = `core:require` v = `{ URLHelper: 'sap/m/library/URLHelper' }` )
    ...
    LOOP AT mt_child INTO DATA(lr_child).
      result = result && CAST zcl_xml_view( lr_child )->xml_get( ).
    ENDLOOP.
  ...
  METHOD field.
    result = _generic( name   = `Field`
                       ...
                       t_prop = VALUE #( ( n = `id`        v = id )
                                         ...
                                         ( n = `showEmptyIndicator`  v = zcl_util=>boolean_abap_2_json( showemptyindicator ) ) ) ).
  ENDMETHOD.
