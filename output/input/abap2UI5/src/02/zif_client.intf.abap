INTERFACE zif_client
  ...
  METHODS get
    RETURNING
      VALUE(result) TYPE zif_types=>ty_s_get.

  METHODS get_app
    IMPORTING
      id            TYPE clike OPTIONAL
    RETURNING
      VALUE(result) TYPE REF TO zif_app.

  METHODS nav_app_leave
    IMPORTING
      VALUE(app)    TYPE REF TO zif_app OPTIONAL
    RETURNING
  ...
  METHODS _event
    IMPORTING
      ...
      s_ctrl        TYPE zif_types=>ty_s_event_control OPTIONAL
  ...
  METHODS _bind
    IMPORTING
      ...
      custom_mapper TYPE REF TO zif_ajson_mapping OPTIONAL
      custom_filter TYPE REF TO zif_ajson_filter OPTIONAL
  ...
  METHODS _bind_edit
    IMPORTING
      val                TYPE data
      path               TYPE abap_bool  DEFAULT abap_false
      view               TYPE string     DEFAULT zif_client=>cs_view-main
      custom_mapper      TYPE REF TO zif_ajson_mapping OPTIONAL
      custom_mapper_back TYPE REF TO zif_ajson_mapping OPTIONAL
      custom_filter      TYPE REF TO zif_ajson_filter OPTIONAL
      custom_filter_back TYPE REF TO zif_ajson_filter OPTIONAL
      tab                TYPE data OPTIONAL
      tab_index          TYPE i    OPTIONAL
    RETURNING
      VALUE(result)      TYPE string.
