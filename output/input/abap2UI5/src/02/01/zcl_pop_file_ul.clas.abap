CLASS zcl_pop_file_ul DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result)       TYPE REF TO zcl_pop_file_ul.
...
CLASS zcl_pop_file_ul IMPLEMENTATION.
  ...
  METHOD zif_app~main.
    ...
    CASE client->get( )-event.
      ...
      WHEN `UPLOAD`.
        ...
        DATA(lv_data2) = zcl_util=>conv_decode_x_base64( lv_data ).
        ms_result-value = zcl_util=>conv_get_string_by_xstring( lv_data2 ).
