CLASS zcl_pop_get_range_m DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      IMPORTING
        val             TYPE zcl_util=>ty_t_filter_multi
      RETURNING
        VALUE(r_result) TYPE REF TO zcl_pop_get_range_m.

    TYPES:
      BEGIN OF ty_s_result,
        t_sql           TYPE zcl_util=>ty_t_filter_multi,
...
CLASS zcl_pop_get_range_m IMPLEMENTATION.
  ...
  METHOD popup_display.
    ...
    DATA(lo_popup) = zcl_xml_view=>factory_popup( ).
  ...
  METHOD zif_app~main.
    ...
    IF client->get( )-check_on_navigated = abap_true.
      ...
      DATA(lo_popup) = CAST zcl_pop_get_range( client->get_app( client->get( )-s_draft-id_prev_app ) ).
      IF lo_popup->result( )-check_confirmed = abap_true.
        ...
        <tab>-t_token = zcl_util=>filter_get_token_t_by_range_t( <tab>-t_range ).
      ENDIF.
      popup_display( ).
    ...
    CASE client->get( )-event.
      ...
      WHEN 'LIST_OPEN'.
        ...
        client->nav_app_call( zcl_pop_get_range=>factory( ls_sql-t_range ) ).
