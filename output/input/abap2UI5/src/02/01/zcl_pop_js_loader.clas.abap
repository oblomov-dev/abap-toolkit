CLASS zcl_pop_js_loader DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result) TYPE REF TO zcl_pop_js_loader.
...
CLASS zcl_pop_js_loader IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    DATA(popup) = zcl_xml_view=>factory_popup( )->dialog( `Setup UI...`
        )->content( ).
