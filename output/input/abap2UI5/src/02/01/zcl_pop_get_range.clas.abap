CLASS zcl_pop_get_range DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result) TYPE REF TO zcl_pop_get_range.

    TYPES:
      BEGIN OF ty_s_result,
        t_range         TYPE zcl_util=>ty_t_range,
    ...
    DATA mt_mapping TYPE zif_types=>ty_t_name_value.
  PROTECTED SECTION.
...
CLASS zcl_pop_get_range IMPLEMENTATION.
  ...
  METHOD zif_app~main.
    ...
    IF check_initialized = abap_false.
      ...
      mt_mapping = zcl_util=>filter_get_token_range_mapping( ).
    ...
    CASE client->get( )-event.
      ...
      WHEN `POPUP_ADD`.
        INSERT VALUE #( key = zcl_util=>uuid_get_c32( ) ) INTO TABLE mt_filter.
