  ...
  PUBLIC SECTION.
    CLASS-METHODS msg_map
      IMPORTING
        name          TYPE clike
        val           TYPE data
        is_msg        TYPE zcl_util=>ty_s_msg
      RETURNING
        VALUE(result) TYPE zcl_util=>ty_s_msg.

    CLASS-METHODS msg_get
      IMPORTING
        val           TYPE any
      RETURNING
        VALUE(result) TYPE zcl_util=>ty_t_msg.
  ...
  METHOD msg_get.
    ...
    CASE lv_kind.
      ...
      WHEN cl_abap_datadescr=>typekind_struct1 OR cl_abap_datadescr=>typekind_struct2.
        ...
        DATA(ls_result) = VALUE zcl_util=>ty_s_msg( ).
              ...
              CATCH cx_root.
                ...
                TRY.
                  ...
                  CATCH cx_root INTO DATA(lx2).
                    ...
                    lt_attri_o = zcl_util=>rtti_get_t_attri_by_oref( val ).
      ...
      WHEN OTHERS.
        ...
        IF zcl_util=>rtti_check_clike( val ).
