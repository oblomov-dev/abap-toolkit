INTERFACE zoblomov_if_ajson_mapping
  PUBLIC.
  ...
  TYPES:
    ty_table_of TYPE STANDARD TABLE OF REF TO zoblomov_if_ajson_mapping.
  ...
  METHODS rename_node
    ...
    CHANGING
      !cv_name TYPE zoblomov_if_ajson_types=>ty_node-name.
