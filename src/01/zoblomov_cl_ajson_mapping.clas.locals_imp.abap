  ...
  METHOD zoblomov_if_ajson_mapping~rename_node.
    ...
    CASE mv_rename_by.
      ...
      WHEN zoblomov_cl_ajson_mapping=>rename_by-full_path.
        ...
        lv_pair_found = boolc( sy-subrc = 0 ).
      WHEN zoblomov_cl_ajson_mapping=>rename_by-pattern.
        lv_full_path = is_node-path && cv_name.
...
CLASS lcl_mapping_to_upper IMPLEMENTATION.
  ...
  METHOD constructor.
    ...
    mi_mapping_fields = zoblomov_cl_ajson_mapping=>create_field_mapping( it_mapping_fields ).
