CLASS zoblomov_cl_ajson DEFINITION
  PUBLIC
  CREATE PUBLIC .

  PUBLIC SECTION.

    INTERFACES zoblomov_if_ajson .

    ALIASES:
      is_empty FOR zoblomov_if_ajson~is_empty,
      exists FOR zoblomov_if_ajson~exists,
      members FOR zoblomov_if_ajson~members,
      get FOR zoblomov_if_ajson~get,
      get_boolean FOR zoblomov_if_ajson~get_boolean,
      get_integer FOR zoblomov_if_ajson~get_integer,
      get_number FOR zoblomov_if_ajson~get_number,
      get_date FOR zoblomov_if_ajson~get_date,
      get_timestamp FOR zoblomov_if_ajson~get_timestamp,
      get_string FOR zoblomov_if_ajson~get_string,
      slice FOR zoblomov_if_ajson~slice,
      to_abap FOR zoblomov_if_ajson~to_abap,
      array_to_string_table FOR zoblomov_if_ajson~array_to_string_table.

    ALIASES:
      clear FOR zoblomov_if_ajson~clear,
      set FOR zoblomov_if_ajson~set,
      setx FOR zoblomov_if_ajson~setx,
      set_boolean FOR zoblomov_if_ajson~set_boolean,
      set_string FOR zoblomov_if_ajson~set_string,
      set_integer FOR zoblomov_if_ajson~set_integer,
      set_date FOR zoblomov_if_ajson~set_date,
      set_timestamp FOR zoblomov_if_ajson~set_timestamp,
      set_null FOR zoblomov_if_ajson~set_null,
      delete FOR zoblomov_if_ajson~delete,
      touch_array FOR zoblomov_if_ajson~touch_array,
      push FOR zoblomov_if_ajson~push,
      stringify FOR zoblomov_if_ajson~stringify.

    ALIASES:
      clone FOR zoblomov_if_ajson~clone,
      filter FOR zoblomov_if_ajson~filter,
      map FOR zoblomov_if_ajson~map.

    ALIASES:
      mt_json_tree FOR zoblomov_if_ajson~mt_json_tree,
      keep_item_order FOR zoblomov_if_ajson~keep_item_order,
      format_datetime FOR zoblomov_if_ajson~format_datetime,
      to_abap_corresponding_only FOR zoblomov_if_ajson~to_abap_corresponding_only,
      freeze FOR zoblomov_if_ajson~freeze.

    CLASS-METHODS parse
      IMPORTING
        !iv_json            TYPE any
        !iv_freeze          TYPE abap_bool DEFAULT abap_false
        !ii_custom_mapping  TYPE REF TO zoblomov_if_ajson_mapping OPTIONAL
        !iv_keep_item_order TYPE abap_bool DEFAULT abap_false
      RETURNING
        VALUE(ro_instance) TYPE REF TO zoblomov_cl_ajson
      RAISING
    ...
    CLASS-METHODS create_from " TODO, rename to 'from' ?
      IMPORTING
        !ii_source_json TYPE REF TO zoblomov_if_ajson
        !ii_filter TYPE REF TO zoblomov_if_ajson_filter OPTIONAL " Might be deprecated, use filter() instead
        !ii_mapper TYPE REF TO zoblomov_if_ajson_mapping OPTIONAL " Might be deprecated, use map() instead
      RETURNING
        VALUE(ro_instance) TYPE REF TO zoblomov_cl_ajson
      RAISING
        zoblomov_cx_ajson_error .
  ...
  PRIVATE SECTION.
    ...
    DATA ms_opts TYPE zoblomov_if_ajson=>ty_opts.
    DATA mi_custom_mapping TYPE REF TO zoblomov_if_ajson_mapping. " DEPRECATED, will be removed

    METHODS get_item
      IMPORTING
        iv_path        TYPE string
      RETURNING
        VALUE(rv_item) TYPE REF TO zoblomov_if_ajson_types=>ty_node.
    METHODS prove_path_exists
      IMPORTING
        iv_path              TYPE string
      RETURNING
        VALUE(rr_end_node) TYPE REF TO zoblomov_if_ajson_types=>ty_node
      RAISING
        zoblomov_cx_ajson_error.
    METHODS delete_subtree
      IMPORTING
        iv_path           TYPE string
        iv_name           TYPE string
        ir_parent         TYPE REF TO zoblomov_if_ajson_types=>ty_node OPTIONAL
      RETURNING
        VALUE(rs_top_node) TYPE zoblomov_if_ajson_types=>ty_node.
...
CLASS zoblomov_cl_ajson IMPLEMENTATION.
  ...
  METHOD create_from.
    ...
    IF ii_source_json IS NOT BOUND.
      zoblomov_cx_ajson_error=>raise( 'Source not bound' ).
    ENDIF.
  ...
  METHOD get_item.
    ...
    DATA ls_path_name TYPE zoblomov_if_ajson_types=>ty_path_name.
    ...
    DO.
      ...
      IF sy-subrc <> 0. " New node, assume it is always object as it has a named child, use touch_array to init array
        ...
        IF lr_node_parent IS NOT INITIAL. " if has parent
          ...
          IF lr_node_parent->type = zoblomov_if_ajson_types=>node_type-array.
        ...
        ls_new_node-type = zoblomov_if_ajson_types=>node_type-object.
  ...
  METHOD read_only_watchdog.
    IF ms_opts-read_only = abap_true.
      zoblomov_cx_ajson_error=>raise( 'This json instance is read only' ).
    ENDIF.
  ENDMETHOD.


  METHOD zoblomov_if_ajson~array_to_string_table.

    DATA lv_normalized_path TYPE string.
    DATA lr_node TYPE REF TO zoblomov_if_ajson_types=>ty_node.
    FIELD-SYMBOLS <item> LIKE LINE OF mt_json_tree.
    ...
    IF lr_node IS INITIAL.
      zoblomov_cx_ajson_error=>raise( |Path not found: { iv_path }| ).
    ENDIF.
    IF lr_node->type <> zoblomov_if_ajson_types=>node_type-array.
      zoblomov_cx_ajson_error=>raise( |Array expected at: { iv_path }| ).
    ENDIF.

    LOOP AT mt_json_tree ASSIGNING <item> WHERE path = lv_normalized_path.
      CASE <item>-type.
        WHEN zoblomov_if_ajson_types=>node_type-number OR zoblomov_if_ajson_types=>node_type-string.
          APPEND <item>-value TO rt_string_table.
        WHEN zoblomov_if_ajson_types=>node_type-null.
          APPEND '' TO rt_string_table.
        WHEN zoblomov_if_ajson_types=>node_type-boolean.
        ...
        WHEN OTHERS.
          zoblomov_cx_ajson_error=>raise( |Cannot convert [{ <item>-type
  ...
  METHOD zoblomov_if_ajson~clear.
  ...
  METHOD zoblomov_if_ajson~clone.
    ri_json = create_from( me ).
  ENDMETHOD.


  METHOD zoblomov_if_ajson~delete.

    read_only_watchdog( ).

    DATA ls_split_path TYPE zoblomov_if_ajson_types=>ty_path_name.
  ...
  METHOD zoblomov_if_ajson~exists.
    rv_exists = boolc( get_item( iv_path ) IS NOT INITIAL ).
  ENDMETHOD.


  METHOD zoblomov_if_ajson~filter.
    ri_json = create_from(
      ii_source_json = me
      ii_filter      = ii_filter ).
  ENDMETHOD.
  ...
  METHOD zoblomov_if_ajson~format_datetime.
    ms_opts-format_datetime = iv_use_iso.
    ri_json = me.
  ENDMETHOD.


  METHOD zoblomov_if_ajson~freeze.
    ms_opts-read_only = abap_true.
  ENDMETHOD.


  METHOD zoblomov_if_ajson~get.

    DATA lr_item TYPE REF TO zoblomov_if_ajson_types=>ty_node.
  ...
  METHOD zoblomov_if_ajson~get_boolean.

    DATA lr_item TYPE REF TO zoblomov_if_ajson_types=>ty_node.
    lr_item = get_item( iv_path ).
    IF lr_item IS INITIAL OR lr_item->type = zoblomov_if_ajson_types=>node_type-null.
      RETURN.
    ELSEIF lr_item->type = zoblomov_if_ajson_types=>node_type-boolean.
  ...
  METHOD zoblomov_if_ajson~get_date.
    ...
    IF lr_item IS NOT INITIAL AND lr_item->type = zoblomov_if_ajson_types=>node_type-string.
  ...
  METHOD zoblomov_if_ajson~get_integer.

    DATA lr_item TYPE REF TO zoblomov_if_ajson_types=>ty_node.
    lr_item = get_item( iv_path ).
    IF lr_item IS NOT INITIAL AND lr_item->type = zoblomov_if_ajson_types=>node_type-number.
      rv_value = lr_item->value.
    ENDIF.
  ...
  METHOD zoblomov_if_ajson~get_node_type.
  ...
  METHOD zoblomov_if_ajson~get_number.
  ...
  METHOD zoblomov_if_ajson~get_string.

    DATA lr_item TYPE REF TO zoblomov_if_ajson_types=>ty_node.
    lr_item = get_item( iv_path ).
    IF lr_item IS NOT INITIAL AND lr_item->type <> zoblomov_if_ajson_types=>node_type-null.
      rv_value = lr_item->value.
    ENDIF.
  ...
  METHOD zoblomov_if_ajson~get_timestamp.
  ...
  METHOD zoblomov_if_ajson~is_empty.
    rv_yes = boolc( lines( mt_json_tree ) = 0 ).
  ENDMETHOD.


  METHOD zoblomov_if_ajson~keep_item_order.
    ms_opts-keep_item_order = abap_true.
    ri_json = me.
  ENDMETHOD.


  METHOD zoblomov_if_ajson~map.
    ri_json = create_from(
      ii_source_json = me
      ii_mapper      = ii_mapper ).
  ENDMETHOD.
  ...
  METHOD zoblomov_if_ajson~members.
  ...
  METHOD zoblomov_if_ajson~opts.
    rs_opts = ms_opts.
  ENDMETHOD.


  METHOD zoblomov_if_ajson~push.

    DATA lr_parent TYPE REF TO zoblomov_if_ajson_types=>ty_node.
    DATA lr_new_node TYPE REF TO zoblomov_if_ajson_types=>ty_node.
    ...
    IF lr_parent IS INITIAL.
      zoblomov_cx_ajson_error=>raise( |Path [{ iv_path }] does not exist| ).
    ENDIF.

    IF lr_parent->type <> zoblomov_if_ajson_types=>node_type-array.
      zoblomov_cx_ajson_error=>raise( |Path [{ iv_path }] is not array| ).
    ENDIF.

    DATA lt_new_nodes TYPE zoblomov_if_ajson_types=>ty_nodes_tt.
    DATA ls_new_path TYPE zoblomov_if_ajson_types=>ty_path_name.
  ...
  METHOD zoblomov_if_ajson~set.

    DATA ls_split_path TYPE zoblomov_if_ajson_types=>ty_path_name.
    DATA lr_parent TYPE REF TO zoblomov_if_ajson_types=>ty_node.
    DATA ls_deleted_node TYPE zoblomov_if_ajson_types=>ty_node.
    DATA lv_item_order TYPE zoblomov_if_ajson_types=>ty_node-order.
    ...
    IF iv_node_type IS NOT INITIAL
      AND iv_node_type <> zoblomov_if_ajson_types=>node_type-boolean AND iv_node_type <> zoblomov_if_ajson_types=>node_type-null
      AND iv_node_type <> zoblomov_if_ajson_types=>node_type-number AND iv_node_type <> zoblomov_if_ajson_types=>node_type-string.
      zoblomov_cx_ajson_error=>raise( |Unexpected type { iv_node_type }| ).
    ENDIF.
    ...
    ELSEIF lr_parent->type = zoblomov_if_ajson_types=>node_type-object
  ...
  METHOD zoblomov_if_ajson~setx.
    ...
    IF lv_val = 'null'.
      zoblomov_if_ajson~set_null( lv_path ).
    ELSEIF lv_val = 'true'.
      zoblomov_if_ajson~set_boolean(
        iv_path = lv_path
        iv_val  = abap_true ).
    ELSEIF lv_val = 'false'.
      zoblomov_if_ajson~set_boolean(
  ...
  METHOD zoblomov_if_ajson~set_boolean.
  ...
  METHOD zoblomov_if_ajson~set_date.
  ...
  METHOD zoblomov_if_ajson~set_integer.
  ...
  METHOD zoblomov_if_ajson~set_null.
  ...
  METHOD zoblomov_if_ajson~set_string.
  ...
  METHOD zoblomov_if_ajson~set_timestamp.
  ...
  METHOD zoblomov_if_ajson~slice.

    DATA lo_section         TYPE REF TO zoblomov_cl_ajson.
    DATA ls_item            LIKE LINE OF mt_json_tree.
    DATA lv_normalized_path TYPE string.
    DATA ls_path_parts      TYPE zoblomov_if_ajson_types=>ty_path_name.
  ...
  METHOD zoblomov_if_ajson~stringify.
  ...
  METHOD zoblomov_if_ajson~touch_array.
    ...
    IF ls_split_path IS INITIAL. " Assign root, exceptional processing
      ...
      ls_new_node-type = zoblomov_if_ajson_types=>node_type-array.
    ...
    ELSEIF lr_node->type <> zoblomov_if_ajson_types=>node_type-array.
      zoblomov_cx_ajson_error=>raise( |Path [{ iv_path }] already used and is not array| ).
    ENDIF.
  ...
  METHOD zoblomov_if_ajson~to_abap.
    ...
    lo_to_abap->to_abap(
      EXPORTING
        it_nodes    = zoblomov_if_ajson~mt_json_tree
      CHANGING
  ...
  METHOD zoblomov_if_ajson~to_abap_corresponding_only.
