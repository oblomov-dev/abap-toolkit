CLASS zoblomov_cl_ajson_mapping DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS create_camel_case " DEPRECATED
      IMPORTING
        it_mapping_fields   TYPE zoblomov_if_ajson_mapping=>ty_mapping_fields OPTIONAL
        iv_first_json_upper TYPE abap_bool DEFAULT abap_true
      RETURNING
        VALUE(ri_mapping)   TYPE REF TO zoblomov_if_ajson_mapping.
    ...
    CLASS-METHODS create_field_mapping " DEPRECATED
      IMPORTING
        it_mapping_fields TYPE zoblomov_if_ajson_mapping=>ty_mapping_fields
      RETURNING
        VALUE(ri_mapping) TYPE REF TO zoblomov_if_ajson_mapping.

    CLASS-METHODS create_rename
      IMPORTING
        it_rename_map TYPE zoblomov_if_ajson_mapping=>tty_rename_map
    ...
    CLASS-METHODS create_compound_mapper
      IMPORTING
        ii_mapper1 TYPE REF TO zoblomov_if_ajson_mapping OPTIONAL
        ii_mapper2 TYPE REF TO zoblomov_if_ajson_mapping OPTIONAL
        ii_mapper3 TYPE REF TO zoblomov_if_ajson_mapping OPTIONAL
        it_more TYPE zoblomov_if_ajson_mapping=>ty_table_of OPTIONAL
      RETURNING
        VALUE(ri_mapping) TYPE REF TO zoblomov_if_ajson_mapping.
...
CLASS zoblomov_cl_ajson_mapping IMPLEMENTATION.
  ...
  METHOD create_compound_mapper.
    ...
    DATA lt_queue TYPE zoblomov_if_ajson_mapping=>ty_table_of.
