...
CLASS lcl_nodes_helper DEFINITION FINAL.
  PUBLIC SECTION.
    ...
    DATA mt_nodes TYPE zoblomov_if_ajson_types=>ty_nodes_tt READ-ONLY.
...
CLASS ltcl_json_utils DEFINITION
  ...
  PRIVATE SECTION.
    ...
    METHODS json_diff FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS json_diff_types FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS json_diff_arrays FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS json_merge FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS json_sort FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS is_equal FOR TESTING RAISING zoblomov_cx_ajson_error.
...
CLASS ltcl_json_utils IMPLEMENTATION.
  ...
  METHOD json_diff.
    ...
    DATA:
      lv_json       TYPE string,
      lo_util       TYPE REF TO zoblomov_cl_ajson_utilities,
      lo_insert     TYPE REF TO zoblomov_if_ajson,
      lo_delete     TYPE REF TO zoblomov_if_ajson,
      lo_change     TYPE REF TO zoblomov_if_ajson,
...
*      '        "row": 4,\n' && " array delete
  ...
  METHOD json_merge.
    ...
    DATA:
      ...
      lv_json_b    TYPE string,
      lo_util      TYPE REF TO zoblomov_cl_ajson_utilities,
      lo_merge     TYPE REF TO zoblomov_if_ajson,
  ...
  METHOD is_equal.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = zoblomov_cl_ajson_utilities=>new( )->is_equal(
        ii_json_a = zoblomov_cl_ajson=>parse( '{"a":1,"b":2}' )
        ii_json_b = zoblomov_cl_ajson=>parse( '{"a":1,"b":2}' ) )
      exp = abap_true ).
