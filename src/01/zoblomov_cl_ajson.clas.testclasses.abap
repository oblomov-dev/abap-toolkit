...
CLASS lcl_nodes_helper DEFINITION FINAL.
  PUBLIC SECTION.
    ...
    DATA mt_nodes TYPE zoblomov_if_ajson_types=>ty_nodes_tt.
    METHODS add
      IMPORTING
        iv_str TYPE string.
    METHODS clear.
    METHODS sorted
      RETURNING
        VALUE(rt_nodes) TYPE zoblomov_if_ajson_types=>ty_nodes_ts.
...
CLASS ltcl_parser_test DEFINITION FINAL
  ...
  PRIVATE SECTION.
    ...
    METHODS setup.
    METHODS parse FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS parse_keeping_order FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS parse_string FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS parse_number FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS parse_float FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS parse_boolean FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS parse_false FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS parse_null FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS parse_date FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS parse_bare_values FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS parse_error FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS parse_input_xstring FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS parse_input_string FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS parse_input_string_table FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS parse_input_error FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS duplicate_key FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS non_json FOR TESTING RAISING zoblomov_cx_ajson_error.
...
CLASS ltcl_parser_test IMPLEMENTATION.
  ...
  METHOD parse_bare_values.
    ...
    DATA lt_act TYPE zoblomov_if_ajson_types=>ty_nodes_tt.
  ...
  METHOD parse_error.
    ...
    DATA lt_act TYPE zoblomov_if_ajson_types=>ty_nodes_tt.
    DATA lx_err TYPE REF TO zoblomov_cx_ajson_error.
    TRY.
        lt_act = mo_cut->parse( 'abc' ).
        cl_abap_unit_assert=>fail( 'Parsing of string w/o quotes must fail (spec)' ).
      CATCH zoblomov_cx_ajson_error INTO lx_err.
  ...
  METHOD parse_input_error.
    ...
    DATA lx TYPE REF TO zoblomov_cx_ajson_error.
    ...
    TRY.
      ...
      CATCH zoblomov_cx_ajson_error INTO lx.
...
CLASS ltcl_serializer_test DEFINITION FINAL
  ...
  PRIVATE SECTION.
    ...
    METHODS stringify_condensed FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS stringify_indented FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS array_index FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS item_order FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS simple_indented FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS empty_set FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS escape_string FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS empty FOR TESTING RAISING zoblomov_cx_ajson_error.
...
CLASS ltcl_utils_test DEFINITION FINAL
  ...
  PRIVATE SECTION.
    ...
    METHODS validate_array_index FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS string_to_xstring_utf8 FOR TESTING.

ENDCLASS.

CLASS zoblomov_cl_ajson DEFINITION LOCAL FRIENDS ltcl_utils_test.
...
CLASS ltcl_utils_test IMPLEMENTATION.
  ...
  METHOD split_path.
    ...
    DATA ls_exp TYPE zoblomov_if_ajson_types=>ty_path_name.
...
CLASS ltcl_reader_test DEFINITION FINAL
  ...
  PRIVATE SECTION.
    ...
    METHODS get_value FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS get_node_type FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS exists FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS value_integer FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS value_number FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS value_boolean FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS value_string FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS members FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS slice FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS array_to_string_table FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS get_date FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS get_timestamp FOR TESTING RAISING zoblomov_cx_ajson_error.

ENDCLASS.

CLASS zoblomov_cl_ajson DEFINITION LOCAL FRIENDS ltcl_reader_test.

CLASS ltcl_reader_test IMPLEMENTATION.

  METHOD slice.

    DATA lo_cut TYPE REF TO zoblomov_cl_ajson.
    DATA lo_nodes TYPE REF TO lcl_nodes_helper.
    ...
    lo_cut = zoblomov_cl_ajson=>parse( ltcl_parser_test=>sample_json( ) ).
    lo_cut ?= lo_cut->zoblomov_if_ajson~slice( '/issues' ).
    cl_abap_unit_assert=>assert_equals(
    ...
    lo_cut = zoblomov_cl_ajson=>parse( ltcl_parser_test=>sample_json( ) ).
    lo_cut ?= lo_cut->zoblomov_if_ajson~slice( '/' ).
    cl_abap_unit_assert=>assert_equals(
      act = lo_cut->mt_json_tree
      exp = lo_nodes->sorted( ) ).
    ...
    lo_cut = zoblomov_cl_ajson=>parse( ltcl_parser_test=>sample_json( ) ).
    lo_cut ?= lo_cut->zoblomov_if_ajson~slice( '/issues/2/start/' ).
    cl_abap_unit_assert=>assert_equals(
      act = lo_cut->mt_json_tree
      exp = lo_nodes->sorted( ) ).
  ...
  METHOD get_value.
    ...
    DATA lo_cut TYPE REF TO zoblomov_if_ajson.
    lo_cut ?= zoblomov_cl_ajson=>parse( ltcl_parser_test=>sample_json( ) ).
  ...
  METHOD get_node_type.
    ...
    DATA li_cut TYPE REF TO zoblomov_if_ajson.
    li_cut = zoblomov_cl_ajson=>parse( ltcl_parser_test=>sample_json( ) ).

    cl_abap_unit_assert=>assert_equals(
      act = li_cut->get_node_type( '/' )
      exp = zoblomov_if_ajson_types=>node_type-object ).
    cl_abap_unit_assert=>assert_equals(
      act = li_cut->get_node_type( '/string' )
      exp = zoblomov_if_ajson_types=>node_type-string ).
    cl_abap_unit_assert=>assert_equals(
      act = li_cut->get_node_type( '/number' )
      exp = zoblomov_if_ajson_types=>node_type-number ).
    cl_abap_unit_assert=>assert_equals(
      act = li_cut->get_node_type( '/float' )
      exp = zoblomov_if_ajson_types=>node_type-number ).
    cl_abap_unit_assert=>assert_equals(
      act = li_cut->get_node_type( '/boolean' )
      exp = zoblomov_if_ajson_types=>node_type-boolean ).
    cl_abap_unit_assert=>assert_equals(
      act = li_cut->get_node_type( '/false' )
      exp = zoblomov_if_ajson_types=>node_type-boolean ).
    cl_abap_unit_assert=>assert_equals(
      act = li_cut->get_node_type( '/null' )
      exp = zoblomov_if_ajson_types=>node_type-null ).
    cl_abap_unit_assert=>assert_equals(
      act = li_cut->get_node_type( '/date' )
      exp = zoblomov_if_ajson_types=>node_type-string ).
    cl_abap_unit_assert=>assert_equals(
      act = li_cut->get_node_type( '/issues' )
      exp = zoblomov_if_ajson_types=>node_type-array ).
  ...
  METHOD get_date.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = lo_cut->zoblomov_if_ajson~get_date( '/date1' )
      exp = lv_exp ).
  ...
  METHOD get_timestamp.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = lo_cut->zoblomov_if_ajson~get_timestamp( '/timestamp' )
      exp = lv_exp ).
  ...
  METHOD array_to_string_table.
    ...
    lt_act = lo_cut->zoblomov_if_ajson~array_to_string_table( '/' ).
    cl_abap_unit_assert=>assert_equals(
      act = lt_act
      exp = lt_exp ).
    ...
    TRY.
        lo_cut->zoblomov_if_ajson~array_to_string_table( '/x' ).
        cl_abap_unit_assert=>fail( ).
      CATCH zoblomov_cx_ajson_error INTO lx.
        cl_abap_unit_assert=>assert_equals(
        act = lx->message
    ...
    TRY.
        lo_cut->zoblomov_if_ajson~array_to_string_table( '/' ).
        cl_abap_unit_assert=>fail( ).
      CATCH zoblomov_cx_ajson_error INTO lx.
        cl_abap_unit_assert=>assert_equals(
        act = lx->message
    ...
    TRY.
        lo_cut->zoblomov_if_ajson~array_to_string_table( '/a' ).
        cl_abap_unit_assert=>fail( ).
      CATCH zoblomov_cx_ajson_error INTO lx.
        cl_abap_unit_assert=>assert_equals(
        act = lx->message
...
CLASS ltcl_json_to_abap DEFINITION
  ...
  PRIVATE SECTION.
    ...
    METHODS to_abap_struc
      FOR TESTING
      RAISING zoblomov_cx_ajson_error.
...
CLASS zoblomov_cl_ajson DEFINITION LOCAL FRIENDS ltcl_json_to_abap.
...
CLASS ltcl_json_to_abap IMPLEMENTATION.
  ...
  METHOD to_abap_corresponding_public.
    ...
    DATA ls_act TYPE ty_struc.
    DATA ls_exp  TYPE ty_struc.
    DATA li_json TYPE REF TO zoblomov_if_ajson.
    DATA lo_nodes TYPE REF TO lcl_nodes_helper.
  ...
  METHOD to_abap_compressed_stdrd.
    ...
    DATA lo_ajson TYPE REF TO zoblomov_cl_ajson.
    ...
    lo_ajson = zoblomov_cl_ajson=>parse( lv_json ).
...
CLASS ltcl_writer_test DEFINITION FINAL
  ...
  PRIVATE SECTION.
    ...
    METHODS set_ajson FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS set_value FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS ignore_empty FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS set_obj FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS set_obj_w_date_time FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS set_tab FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS set_tab_hashed FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS set_tab_nested_struct FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS prove_path_exists FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS delete_subtree FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS delete FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS arrays FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS arrays_negative FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS root_assignment FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS set_bool_abap_bool FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS set_bool_int FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS set_bool_tab FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS set_str FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS set_int FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS set_number FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS set_date FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS set_timestamp FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS read_only FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS set_array_obj FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS set_with_type FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS new_array_w_keep_order_touch FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS overwrite_w_keep_order_touch FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS overwrite_w_keep_order_set FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS setx FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS setx_float FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS setx_complex FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS setx_complex_w_keep_order FOR TESTING RAISING zoblomov_cx_ajson_error.

    METHODS set_with_type_slice
      IMPORTING
        io_json_in TYPE REF TO zoblomov_cl_ajson
        io_json_out TYPE REF TO zoblomov_if_ajson
        iv_path TYPE string
      RAISING
        zoblomov_cx_ajson_error.

ENDCLASS.

CLASS zoblomov_cl_ajson DEFINITION LOCAL FRIENDS ltcl_writer_test.
...
CLASS ltcl_writer_test IMPLEMENTATION.
  ...
  METHOD prove_path_exists.
    ...
    lo_cut = zoblomov_cl_ajson=>create_empty( ).
  ...
  METHOD delete.
    ...
    lo_cut->zoblomov_if_ajson~delete( iv_path = '/a/b' ).
  ...
  METHOD set_ajson.
    ...
    DATA lo_nodes TYPE REF TO lcl_nodes_helper.
    DATA lo_src TYPE REF TO zoblomov_cl_ajson.
    DATA lo_cut TYPE REF TO zoblomov_cl_ajson.
    DATA li_writer TYPE REF TO zoblomov_if_ajson.

    lo_src = zoblomov_cl_ajson=>create_empty( ).
    lo_cut = zoblomov_cl_ajson=>create_empty( ).
    li_writer = lo_cut.
  ...
  METHOD ignore_empty.
    ...
    li_cut = zoblomov_cl_ajson=>create_empty( ).
  ...
  METHOD set_obj_w_date_time.
    ...
    lo_cut = zoblomov_cl_ajson=>create_empty( )->format_datetime( ).
    li_writer = lo_cut.
  ...
  METHOD set_number.
    ...
    li_json = zoblomov_cl_ajson=>create_empty( ).
    CREATE OBJECT lo_nodes_exp.
    lo_nodes_exp->add( '        |      |object |         ||1' ).
  ...
  METHOD set_with_type.
    ...
    DATA lo_sample TYPE REF TO zoblomov_cl_ajson.
    DATA lo_cut TYPE REF TO zoblomov_cl_ajson.
    DATA li_writer TYPE REF TO zoblomov_if_ajson.

    lo_sample = zoblomov_cl_ajson=>parse( ltcl_parser_test=>sample_json( ) ).
  ...
  METHOD setx.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = zoblomov_cl_ajson=>new( )->setx( '/a:1' )->stringify( )
      exp = '{"a":1}' ).
    ...
    cl_abap_unit_assert=>assert_equals(
      act = zoblomov_cl_ajson=>new( )->setx( '/a:abc' )->stringify( )
      exp = '{"a":"abc"}' ).

    cl_abap_unit_assert=>assert_equals(
      act = zoblomov_cl_ajson=>new( )->setx( '/a:null' )->stringify( )
      exp = '{"a":null}' ).

    cl_abap_unit_assert=>assert_equals(
      act = zoblomov_cl_ajson=>new( )->setx( '/a:true' )->stringify( )
      exp = '{"a":true}' ).
    ...
    cl_abap_unit_assert=>assert_equals(
      act = zoblomov_cl_ajson=>new( )->setx( '/a:false' )->stringify( )
      exp = '{"a":false}' ).

    cl_abap_unit_assert=>assert_equals(
      act = zoblomov_cl_ajson=>new( )->setx( '/a/b:1' )->stringify( )
      exp = '{"a":{"b":1}}' ).

    cl_abap_unit_assert=>assert_equals(
      act = zoblomov_cl_ajson=>new( )->setx( '/:1' )->stringify( )
...
*      exp = '{}' ). " should setx ignore empty values or set an empty string ? Or null ?
    ...
    cl_abap_unit_assert=>assert_equals(
      act = zoblomov_cl_ajson=>new( )->setx( '/a:""' )->stringify( )
      exp = '{"a":""}' ).
  ...
  METHOD setx_float.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = zoblomov_cl_ajson=>new( )->setx( '/a:1.123' )->stringify( )
      exp = '{"a":1.123}' ).

    cl_abap_unit_assert=>assert_equals(
      act = zoblomov_cl_ajson=>new( )->setx( '/a:00.123' )->stringify( )
      exp = '{"a":"00.123"}' ). " not a number

    cl_abap_unit_assert=>assert_equals(
      act = zoblomov_cl_ajson=>new( )->setx( '/a:.123' )->stringify( )
      exp = '{"a":".123"}' ).
  ...
  METHOD setx_complex.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = zoblomov_cl_ajson=>new( )->setx( '/a:[1, 2]' )->stringify( )
      exp = '{"a":[1,2]}' ).
    ...
    TRY.
        zoblomov_cl_ajson=>new( )->setx( '/a:{"b" : 1' ).
        cl_abap_unit_assert=>fail( ).
      CATCH zoblomov_cx_ajson_error.
    ENDTRY.

    TRY.
        zoblomov_cl_ajson=>new( )->setx( '/a:[1, 2' ).
        cl_abap_unit_assert=>fail( ).
      CATCH zoblomov_cx_ajson_error.
    ENDTRY.
  ...
  METHOD setx_complex_w_keep_order.
    ...
    li_cut = zoblomov_cl_ajson=>new( iv_keep_item_order = abap_true ).
    li_cut->setx( '/c:3' ).
    li_cut->set(
      iv_path = '/b'
      iv_val  = ls_dummy ).
...
CLASS ltcl_integrated DEFINITION
  ...
  PRIVATE SECTION.
    ...
    METHODS reader FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS array_index FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS array_simple FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS stringify FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS item_order_integrated FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS chaining FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS push_json FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS is_empty FOR TESTING RAISING zoblomov_cx_ajson_error.
...
CLASS ltcl_integrated IMPLEMENTATION.
  ...
  METHOD array_simple.
    ...
    DATA li_reader TYPE REF TO zoblomov_if_ajson.
    li_reader = zoblomov_cl_ajson=>parse( lv_src ).
  ...
  METHOD reader.
    ...
    li_reader = zoblomov_cl_ajson=>parse( lv_source ).
  ...
  METHOD stringify.
    ...
    DATA: BEGIN OF ls_data, str TYPE string, cls TYPE REF TO zoblomov_cl_ajson, END OF ls_data.
  ...
  METHOD push_json.
    ...
    DATA li_cut TYPE REF TO zoblomov_if_ajson.
    DATA li_sub TYPE REF TO zoblomov_if_ajson.
    DATA lv_act TYPE string.
    DATA lv_exp TYPE string.

    li_cut = zoblomov_cl_ajson=>create_empty( ).
    li_sub = zoblomov_cl_ajson=>create_empty( )->set(
      iv_path = 'a'
      iv_val  = '1' ).
    ...
    li_cut->push(
      iv_path = '/list'
      iv_val  = zoblomov_cl_ajson=>create_empty( )->set(
        iv_path = 'a'
        iv_val  = '1' ) ).
    li_cut->push(
      iv_path = '/list'
...
CLASS ltcl_abap_to_json DEFINITION
  ...
  PRIVATE SECTION.
    ...
    METHODS set_ajson FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS set_value_number FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS set_value_string FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS set_value_true FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS set_value_false FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS set_value_xsdboolean FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS set_value_timestamp FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS set_value_timestamp_initial FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS set_null FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS set_obj FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS set_array FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS set_complex_obj FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS set_include_with_suffix FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS prefix FOR TESTING RAISING zoblomov_cx_ajson_error.

ENDCLASS.

CLASS zoblomov_cl_ajson DEFINITION LOCAL FRIENDS ltcl_abap_to_json.
...
CLASS ltcl_abap_to_json IMPLEMENTATION.
  ...
  METHOD set_ajson.
    ...
    DATA lt_nodes TYPE zoblomov_if_ajson_types=>ty_nodes_tt.
  ...
  METHOD prefix.
    ...
    DATA lo_nodes_exp TYPE REF TO lcl_nodes_helper.
    DATA lt_nodes TYPE zoblomov_if_ajson_types=>ty_nodes_tt.
    DATA ls_prefix TYPE zoblomov_if_ajson_types=>ty_path_name.
...
CLASS ltcl_filter_test DEFINITION FINAL
  ...
  PUBLIC SECTION.
    INTERFACES zoblomov_if_ajson_filter.
  ...
  PRIVATE SECTION.
    ...
    TYPES:
      BEGIN OF ty_visit_history,
        path TYPE string,
        type TYPE zoblomov_if_ajson_filter=>ty_visit_type,
      END OF ty_visit_history.

    DATA mt_visit_history TYPE TABLE OF ty_visit_history.

    METHODS simple_test FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS array_test FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS visit_types FOR TESTING RAISING zoblomov_cx_ajson_error.
...
CLASS ltcl_filter_test IMPLEMENTATION.
  ...
  METHOD zoblomov_if_ajson_filter~keep_node.
  ...
  METHOD simple_test.
    ...
    DATA lo_json TYPE REF TO zoblomov_cl_ajson.
    DATA lo_json_filtered TYPE REF TO zoblomov_cl_ajson.
    DATA lo_nodes_exp TYPE REF TO lcl_nodes_helper.

    lo_json = zoblomov_cl_ajson=>create_empty( ).
    lo_json->set(
      iv_path = '/a'
      iv_val  = 1 ).
    lo_json->set(
    ...
    lo_json_filtered = zoblomov_cl_ajson=>create_from(
  ...
  METHOD visit_types.
    ...
    <v>-path = '/'.
    <v>-type = zoblomov_if_ajson_filter=>visit_type-open.
    APPEND INITIAL LINE TO lt_visits_exp ASSIGNING <v>.
    <v>-path = '/3/'.
    <v>-type = zoblomov_if_ajson_filter=>visit_type-open.
    APPEND INITIAL LINE TO lt_visits_exp ASSIGNING <v>.
    <v>-path = '/3/'.
    <v>-type = zoblomov_if_ajson_filter=>visit_type-close.
    APPEND INITIAL LINE TO lt_visits_exp ASSIGNING <v>.
    <v>-path = '/'.
    <v>-type = zoblomov_if_ajson_filter=>visit_type-close.
...
CLASS ltcl_mapper_test DEFINITION FINAL
  ...
  PUBLIC SECTION.
    INTERFACES zoblomov_if_ajson_mapping.

  PRIVATE SECTION.

    METHODS simple_test FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS array_test FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS duplication_test FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS empty_name_test FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS trivial FOR TESTING RAISING zoblomov_cx_ajson_error.

ENDCLASS.

CLASS ltcl_mapper_test IMPLEMENTATION.

  METHOD zoblomov_if_ajson_mapping~rename_node.
    IF cv_name+0(1) = 'a'.
  ...
  METHOD zoblomov_if_ajson_mapping~to_abap.
  ENDMETHOD.

  METHOD zoblomov_if_ajson_mapping~to_json.
  ENDMETHOD.
...
CLASS ltcl_cloning_test DEFINITION FINAL
  ...
  PRIVATE SECTION.
    ...
    METHODS clone_test FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS filter_test FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS mapper_test FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS mapper_and_filter FOR TESTING RAISING zoblomov_cx_ajson_error.
    METHODS opts_copying FOR TESTING RAISING zoblomov_cx_ajson_error.
...
CLASS ltcl_cloning_test IMPLEMENTATION.
  ...
  METHOD clone_test.
    ...
    DATA li_json TYPE REF TO zoblomov_if_ajson.
    DATA li_json_new TYPE REF TO zoblomov_if_ajson.
    DATA lo_nodes_exp TYPE REF TO lcl_nodes_helper.
  ...
  METHOD mapper_and_filter.
    ...
    li_json_new = zoblomov_cl_ajson=>create_from(
  ...
  METHOD opts_copying.
    ...
    li_json = zoblomov_cl_ajson=>new( )->keep_item_order( ).
    li_json->set(
      iv_path = '/ab'
      iv_val  = 1 ).
