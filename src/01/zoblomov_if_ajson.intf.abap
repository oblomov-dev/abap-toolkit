INTERFACE zoblomov_if_ajson
  ...
  DATA mt_json_tree TYPE zoblomov_if_ajson_types=>ty_nodes_ts READ-ONLY.

  " CLONING

  METHODS clone
    RETURNING
      VALUE(ri_json) TYPE REF TO zoblomov_if_ajson
    RAISING
  ...
  METHODS get_node_type
    IMPORTING
      iv_path TYPE string
    RETURNING
      VALUE(rv_node_type) TYPE zoblomov_if_ajson_types=>ty_node_type.
  ...
  METHODS set
    IMPORTING
      ...
      iv_node_type TYPE zoblomov_if_ajson_types=>ty_node_type OPTIONAL
    RETURNING
      VALUE(ri_json) TYPE REF TO zoblomov_if_ajson
    RAISING
      zoblomov_cx_ajson_error.
