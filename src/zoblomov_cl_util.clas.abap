CLASS zoblomov_cl_util DEFINITION
  PUBLIC
  INHERITING FROM zoblomov_cl_util_abap
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS rtti_get_t_ddic_fixed_values
      ...
      RETURNING
        VALUE(result) TYPE zoblomov_cl_util_abap=>ty_t_fix_val ##NEEDED.
    ...
    CLASS-METHODS filter_get_sql_where
      IMPORTING
        val           TYPE  zoblomov_cl_util=>ty_t_filter_multi
      RETURNING
        VALUE(result) TYPE string.
...
CLASS zoblomov_cl_util IMPLEMENTATION.
  ...
  METHOD filter_get_multi_by_data.
    ...
    LOOP AT temp5 REFERENCE INTO lr_comp.
      DATA temp6 TYPE zoblomov_cl_util=>ty_s_filter_multi.
      CLEAR temp6.
  ...
  METHOD filter_update_tokens.
    ...
    result = val.
    FIELD-SYMBOLS <temp7> TYPE zoblomov_cl_util=>ty_s_filter_multi.
...
GET REFERENCE OF <temp7> INTO lr_filter.
    ...
    LOOP AT lr_filter->t_token_added INTO ls_token.
      DATA temp8 TYPE zoblomov_cl_util=>ty_s_token.
      CLEAR temp8.
    ...
    DATA lt_token TYPE zoblomov_cl_util=>ty_t_token.
    ...
    DATA lt_range TYPE zoblomov_cl_util=>ty_t_range.
    ...
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    lt_range = zoblomov_cl_util=>filter_get_range_t_by_token_t( temp4-t_token ).
  ...
  METHOD filter_get_token_range_mapping.
    ...
    DATA temp9 TYPE zoblomov_cl_util=>ty_t_name_value.
    CLEAR temp9.
  ...
  METHOD filter_get_token_t_by_range_t.
    ...
    DATA lt_mapping TYPE zoblomov_cl_util=>ty_t_name_value.
    ...
    LOOP AT lt_tab REFERENCE INTO lr_row.
      ...
      DATA lv_value TYPE zoblomov_cl_util=>ty_s_name_value-v.
      ...
      DATA temp13 TYPE zoblomov_cl_util=>ty_s_token.
      CLEAR temp13.
      temp13-key = lv_value.
...
DATA lt_cols TYPE temp2.
  ...
  METHOD json_parse.
    TRY.
        ...
        zoblomov_cl_ajson=>parse( val )->to_abap( EXPORTING iv_corresponding = abap_true
  ...
  METHOD json_stringify.
    TRY.
        ...
        DATA temp21 TYPE REF TO zoblomov_if_ajson.
        temp21 ?= zoblomov_cl_ajson=>create_empty( ).
  ...
  METHOD rtti_get_t_attri_by_include.
    ...
    temp25 ?= cl_abap_typedescr=>describe_by_name( type->absolute_name ).
  ...
  METHOD rtti_get_t_attri_by_any.
    ...
    DATA temp35 LIKE LINE OF result.
...
|x, nsis, objectivec, ocaml, pascal, perl, pgsql, php, plain_text, powershell, praat, prolog, properties, protobuf, python, r, razor, rdoc, rhtml, rst, ruby, rust, sass, scad, scala, scheme, scss, sh, sjs, smarty, snippets, soy_template, space, sql,| &&
  ...
  METHOD url_param_get.
    ...
    DATA lt_params TYPE zoblomov_cl_util=>ty_t_name_value.
    lt_params = url_param_get_tab( url ).
    DATA lv_val TYPE string.
    lv_val = c_trim_lower( val ).
    DATA temp41 TYPE string.
    CLEAR temp41.
    DATA temp42 TYPE zoblomov_cl_util=>ty_s_name_value.
...
*                      v = c_trim_lower( lv_value ) ) INTO TABLE rt_params.
      DATA temp45 TYPE zoblomov_cl_util=>ty_s_name_value.
      CLEAR temp45.
      temp45-n = lv_name.
      temp45-v = lv_value.
  ...
  METHOD url_param_set.
    ...
    ENDLOOP.
    IF sy-subrc <> 0.
      DATA temp47 TYPE zoblomov_cl_util=>ty_s_name_value.
      CLEAR temp47.
      temp47-n = lv_n.
  ...
  METHOD xml_srtti_stringify.
    ...
    ELSE.
      ...
      TRY.
          CALL METHOD zoblomov_cl_srt_typedescr=>('CREATE_BY_DATA_OBJECT')
            EXPORTING
              data_object = data
            RECEIVING
              srtti       = srtti.
...
DATA lo_range TYPE REF TO zoblomov_cl_util_range.
CREATE OBJECT lo_range TYPE zoblomov_cl_util_range EXPORTING iv_fieldname = ls_filter-name ir_range = temp52.
  ...
  METHOD msg_get_t.
    ...
    result = zoblomov_cl_util_msg=>msg_get( val ).
  ...
  METHOD msg_get.
    ...
    DATA lt_msg TYPE zoblomov_cl_util=>ty_t_msg.
