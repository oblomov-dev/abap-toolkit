CLASS zoblomov_cl_srt_aunit DEFINITION
  PUBLIC
  FOR TESTING
  FINAL
  CREATE PUBLIC .
...
CLASS zoblomov_cl_srt_aunit IMPLEMENTATION.
  ...
  METHOD serialize_deserialize.
    ...
    DATA srtti1 TYPE REF TO zoblomov_cl_srt_typedescr.
    DATA xstring TYPE xstring.
    DATA srtti2 TYPE REF TO zoblomov_cl_srt_typedescr.
    ...
    srtti1 = zoblomov_cl_srt_typedescr=>create_by_data_object( <variable1> ).
