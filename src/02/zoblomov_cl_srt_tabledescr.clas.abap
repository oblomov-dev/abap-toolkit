...
CLASS zoblomov_cl_srt_tabledescr DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    DATA line_type      TYPE REF TO zoblomov_cl_srt_datadescr.
...
CLASS zoblomov_cl_srt_tabledescr IMPLEMENTATION.
  METHOD constructor.
    ...
    line_type ?= zoblomov_cl_srt_typedescr=>create_by_rtti( rtti->get_table_line_type( ) ).
