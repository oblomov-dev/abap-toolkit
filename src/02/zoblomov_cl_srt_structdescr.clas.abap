...
CLASS zoblomov_cl_srt_structdescr DEFINITION
  PUBLIC
  INHERITING FROM zoblomov_cl_srt_complexdescr
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF sabap_componentdescr,
        name       TYPE string,
        type       TYPE REF TO zoblomov_cl_srt_datadescr,
...
CLASS zoblomov_cl_srt_structdescr IMPLEMENTATION.
  METHOD constructor.
    DATA components_rtti TYPE abap_component_tab.
    DATA scomponent      TYPE sabap_componentdescr.
    DATA scomponent_rtti TYPE REF TO zoblomov_cl_srt_datadescr.
    ...
    LOOP AT components_rtti ASSIGNING <component>.
      ...
      scomponent_rtti ?= zoblomov_cl_srt_datadescr=>create_by_rtti( <component>-type ).
