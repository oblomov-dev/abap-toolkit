...
CLASS zoblomov_cl_util_msg IMPLEMENTATION.
  METHOD msg_get.
    ...
    lv_kind = zoblomov_cl_util=>rtti_get_type_kind( val ).
    CASE lv_kind.
      ...
      WHEN cl_abap_datadescr=>typekind_table.
        ...
        LOOP AT <tab> ASSIGNING <row>.
          DATA lt_tab TYPE zoblomov_cl_util=>ty_t_msg.
          lt_tab = msg_get( <row> ).
      ...
      WHEN cl_abap_datadescr=>typekind_struct1 OR cl_abap_datadescr=>typekind_struct2.
        ...
        lt_attri = zoblomov_cl_util=>rtti_get_t_attri_by_any( val ).

        DATA temp1 TYPE zoblomov_cl_util=>ty_s_msg.
        CLEAR temp1.
        ...
        TRY.
          ...
          CATCH cx_root.
            ...
            TRY.
                ...
                DATA lt_tab2 TYPE zoblomov_cl_util=>ty_t_msg.
      ...
      WHEN OTHERS.
        ...
        IF zoblomov_cl_util=>rtti_check_clike( val ) IS NOT INITIAL.
          DATA temp5 TYPE zoblomov_cl_util=>ty_s_msg.
          CLEAR temp5.
          temp5-text = val.
          INSERT temp5
                 INTO TABLE result.
